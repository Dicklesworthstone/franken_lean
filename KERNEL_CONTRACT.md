...
anchor: vendor/lean4-src/src/kernel/type_checker.cpp:289 (infer_type_core) expect="BVar"
fixtures: stub owner=franken_lean-z6c
...
anchor: vendor/lean4-src/src/kernel/type_checker.cpp:289 (infer_type_core) expect="MVar"
fixtures: stub owner=franken_lean-z6c
...
### KR-110 · Literals
anchor: vendor/lean4-src/src/kernel/type_checker.cpp:289 (infer_type_core) expect="Lit"
fixtures: stub owner=franken_lean-z6c
A `Nat` literal types as `Nat`; a `String` literal as `String`. No premises.

### KR-111 · Metadata is transparent
anchor: vendor/lean4-src/src/kernel/type_checker.cpp:289 (infer_type_core) expect="MData"
fixtures: stub owner=franken_lean-z6c
...
### KR-202 · Beta
anchor: vendor/lean4-src/src/kernel/type_checker.cpp:465 (whnf_core) expect="App"
fixtures: stub owner=franken_lean-z6c
...
anchor: vendor/lean4-src/src/kernel/type_checker.cpp:465 (whnf_core) expect="Let"
...
anchor: vendor/lean4-src/src/kernel/type_checker.cpp:1085 (is_def_eq_core) expect="m_eager_reduce"
fixtures: stub owner=franken_lean-z6c
...
anchor: vendor/lean4-src/src/kernel/type_checker.cpp:1085 (is_def_eq_core) expect="whnf_core"
fixtures: stub owner=franken_lean-z6c
...
anchor: vendor/lean4-src/src/kernel/type_checker.cpp:1085 (is_def_eq_core) expect="is_constant"
fixtures: stub owner=franken_lean-z6c
...
anchor: vendor/lean4-src/src/kernel/type_checker.cpp:289 (infer_type_core) expect="check_system"
fixtures: stub owner=franken_lean-z6c
Every inference node counts.

### KR-401 · Normalization hook
anchor: vendor/lean4-src/src/kernel/type_checker.cpp:420 (whnf_core) expect="check_system"
fixtures: stub owner=franken_lean-z6c
Every whnf-core entry counts.

### KR-402 · Defeq hook
anchor: vendor/lean4-src/src/kernel/type_checker.cpp:1085 (is_def_eq_core) expect="check_system"
fixtures: stub owner=franken_lean-z6c
...
anchor: vendor/lean4-src/src/kernel/type_checker.cpp:240 (infer_proj) expect="is_prop"
fixtures: stub owner=franken_lean-z6c
...
anchor: vendor/lean4-src/src/kernel/type_checker.cpp:111 (infer_constant) expect="is_unsafe"
fixtures: stub owner=franken_lean-z6c
...
anchor: vendor/lean4-src/src/kernel/type_checker.cpp:111 (infer_constant) expect="partial"
fixtures: stub owner=franken_lean-z6c
