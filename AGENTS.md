...
7. **The recurring defect: evidence must be produced where the claim is made.** Stated once, generally, because it has now been found seven times and every single time by somebody *reading carefully* rather than by a check:
   ...
   The seven, with the join that was unwatched — and, more usefully, whether anything would catch a recurrence:
