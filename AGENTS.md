...
```text
cite tools/structure-guard/src/checks.rs:1639 :: constitutional prohibition
cite tools/structure-guard/src/checks.rs:1890 :: let mut actual_edges
cite tools/structure-guard/src/checks.rs:1996 :: (CrateKind::Tool, _)
cite tools/structure-guard/src/checks.rs:2047 :: code: "FLN-STRUCT-008"
