...
use structure_guard::{NDJSON_SCHEMA, checks, report};
...
mod tests {
    ...
    fn publication_robot_records_are_single_line_terminal_and_escaped() {
        ...
        assert!(success.contains(&format!("\"schema\":\"{NDJSON_SCHEMA}\"")));
        ...
        assert!(failure.contains(&format!("\"schema\":\"{NDJSON_SCHEMA}\"")));
