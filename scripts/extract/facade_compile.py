...
def main():
    ...
    roundtrip_transparent_value_inequality_join = {
        "summary_type_roundtrip_checked": manifest_summary.get(
            "type_roundtrip_checked"
        ),
        "summary_transparent_values_checked": manifest_summary.get(
    ...
    if (not isinstance(roundtrip_transparent_value_inequality_join[
            "summary_type_roundtrip_checked"], int)
            or isinstance(roundtrip_transparent_value_inequality_join[
                "summary_type_roundtrip_checked"], bool)
            or not isinstance(roundtrip_transparent_value_inequality_join[
                "summary_transparent_values_checked"], int)
            or isinstance(roundtrip_transparent_value_inequality_join[
                "summary_transparent_values_checked"], bool)
            or roundtrip_transparent_value_inequality_join[
                "summary_type_roundtrip_checked"]
            <= roundtrip_transparent_value_inequality_join[
                "summary_transparent_values_checked"]):
        raise SystemExit(
            "REFUSE: facade manifest roundtrip count must exceed transparent "
            f"value count ({json.dumps(roundtrip_transparent_value_inequality_join, sort_keys=True)})"
        )
    ...
    if (not isinstance(transparent_value_explicit_inequality_join[
            "summary_transparent_values_checked"], int)
            or isinstance(transparent_value_explicit_inequality_join[
                "summary_transparent_values_checked"], bool)
            or not isinstance(transparent_value_explicit_inequality_join[
                "summary_transparent_explicit_value"], int)
            or isinstance(transparent_value_explicit_inequality_join[
                "summary_transparent_explicit_value"], bool)
            or transparent_value_explicit_inequality_join[
                "summary_transparent_values_checked"]
            <= transparent_value_explicit_inequality_join[
    ...
    class_projection_type_inequality_join = {
        "summary_class_provided_projections": manifest_summary.get(
            "class_provided_projections"
        ),
        "summary_projection_types_checked": manifest_summary.get(
    ...
    if (not isinstance(class_projection_type_inequality_join[
            "summary_class_provided_projections"], int)
            or isinstance(class_projection_type_inequality_join[
                "summary_class_provided_projections"], bool)
            or not isinstance(class_projection_type_inequality_join[
                "summary_projection_types_checked"], int)
            or isinstance(class_projection_type_inequality_join[
                "summary_projection_types_checked"], bool)
            or class_projection_type_inequality_join[
                "summary_class_provided_projections"]
            <= class_projection_type_inequality_join[
                "summary_projection_types_checked"]):
        raise SystemExit(
            "REFUSE: facade manifest class-projection count must exceed "
            f"projection-type count ({json.dumps(class_projection_type_inequality_join, sort_keys=True)})"
        )
    substrate_bare_name_inequality_join = {
        "summary_substrate_emitted": manifest_summary.get("substrate_emitted"),
        "summary_bare_names_probed": manifest_summary.get("bare_names_probed"),
    }
    if (not isinstance(substrate_bare_name_inequality_join[
            "summary_substrate_emitted"], int)
            or isinstance(substrate_bare_name_inequality_join[
                "summary_substrate_emitted"], bool)
            or not isinstance(substrate_bare_name_inequality_join[
                "summary_bare_names_probed"], int)
            or isinstance(substrate_bare_name_inequality_join[
                "summary_bare_names_probed"], bool)
            or substrate_bare_name_inequality_join["summary_substrate_emitted"]
            <= substrate_bare_name_inequality_join["summary_bare_names_probed"]):
        raise SystemExit(
            "REFUSE: facade manifest substrate-emission count must exceed "
            f"bare-name probe count ({json.dumps(substrate_bare_name_inequality_join, sort_keys=True)})"
        )
    ...
    if (not isinstance(bare_name_projection_inequality_join[
            "summary_bare_names_probed"], int)
            or isinstance(bare_name_projection_inequality_join[
                "summary_bare_names_probed"], bool)
            or not isinstance(bare_name_projection_inequality_join[
                "summary_projection_types_checked"], int)
            or isinstance(bare_name_projection_inequality_join[
                "summary_projection_types_checked"], bool)
            or bare_name_projection_inequality_join["summary_bare_names_probed"]
            <= bare_name_projection_inequality_join[
                "summary_projection_types_checked"]):
        raise SystemExit(
    ...
    if (not isinstance(class_projection_declaration_inequality_join[
            "summary_class_provided_projections"], int)
            or isinstance(class_projection_declaration_inequality_join[
                "summary_class_provided_projections"], bool)
            or not isinstance(class_projection_declaration_inequality_join[
                "summary_declarations_emitted"], int)
            or isinstance(class_projection_declaration_inequality_join[
                "summary_declarations_emitted"], bool)
            or class_projection_declaration_inequality_join[
                "summary_class_provided_projections"]
            <= class_projection_declaration_inequality_join[
                "summary_declarations_emitted"]):
        raise SystemExit(
    ...
    demanded_init_substrate_inequality_join = {
    ...
    if (not isinstance(demanded_init_substrate_inequality_join[
            "summary_demanded"], int)
            or isinstance(demanded_init_substrate_inequality_join[
                "summary_demanded"], bool)
            or not isinstance(demanded_init_substrate_inequality_join[
                "summary_demanded_init_substrate"], int)
            or isinstance(demanded_init_substrate_inequality_join[
                "summary_demanded_init_substrate"], bool)
            or demanded_init_substrate_inequality_join["summary_demanded"]
            <= demanded_init_substrate_inequality_join[
                "summary_demanded_init_substrate"]):
        raise SystemExit(
            "REFUSE: facade manifest demanded count must exceed demanded "
            f"Init-substrate count ({json.dumps(demanded_init_substrate_inequality_join, sort_keys=True)})"
        )
    demanded_init_check_inequality_join = {
        "summary_demanded": manifest_summary.get("demanded"),
        "summary_init_substrate_checked": manifest_summary.get(
            "init_substrate_checked"
        ),
    }
    if (not isinstance(demanded_init_check_inequality_join[
            "summary_demanded"], int)
            or isinstance(demanded_init_check_inequality_join[
                "summary_demanded"], bool)
            or not isinstance(demanded_init_check_inequality_join[
                "summary_init_substrate_checked"], int)
            or isinstance(demanded_init_check_inequality_join[
                "summary_init_substrate_checked"], bool)
            or demanded_init_check_inequality_join["summary_demanded"]
            <= demanded_init_check_inequality_join[
                "summary_init_substrate_checked"]):
        raise SystemExit(
            "REFUSE: facade manifest demanded count must exceed Init-substrate "
            f"check count ({json.dumps(demanded_init_check_inequality_join, sort_keys=True)})"
        )
    projection_transparent_declaration_inequality_join = {
        "summary_projection_types_checked": manifest_summary.get(
            "projection_types_checked"
        ),
        "summary_transparent_declarations": manifest_summary.get(
    ...
    if (not isinstance(projection_transparent_declaration_inequality_join[
            "summary_projection_types_checked"], int)
            or isinstance(projection_transparent_declaration_inequality_join[
                "summary_projection_types_checked"], bool)
            or not isinstance(projection_transparent_declaration_inequality_join[
                "summary_transparent_declarations"], int)
            or isinstance(projection_transparent_declaration_inequality_join[
                "summary_transparent_declarations"], bool)
            or projection_transparent_declaration_inequality_join[
                "summary_projection_types_checked"]
            <= projection_transparent_declaration_inequality_join[
                "summary_transparent_declarations"]):
        raise SystemExit(
            "REFUSE: facade manifest projection-type count must exceed "
            f"transparent-declaration count ({json.dumps(projection_transparent_declaration_inequality_join, sort_keys=True)})"
        )
    projection_transparent_value_inequality_join = {
        "summary_projection_types_checked": manifest_summary.get(
            "projection_types_checked"
        ),
        "summary_transparent_values_checked": manifest_summary.get(
    ...
    if (not isinstance(projection_transparent_value_inequality_join[
            "summary_projection_types_checked"], int)
            or isinstance(projection_transparent_value_inequality_join[
                "summary_projection_types_checked"], bool)
            or not isinstance(projection_transparent_value_inequality_join[
                "summary_transparent_values_checked"], int)
            or isinstance(projection_transparent_value_inequality_join[
                "summary_transparent_values_checked"], bool)
            or projection_transparent_value_inequality_join[
                "summary_projection_types_checked"]
            <= projection_transparent_value_inequality_join[
                "summary_transparent_values_checked"]):
        raise SystemExit(
            "REFUSE: facade manifest projection-type count must exceed "
            f"transparent-value count ({json.dumps(projection_transparent_value_inequality_join, sort_keys=True)})"
        )
    transparent_declaration_explicit_inequality_join = {
        "summary_transparent_declarations": manifest_summary.get(
            "transparent_declarations"
        ),
        "summary_transparent_explicit_value": manifest_summary.get(
    ...
    if (not isinstance(transparent_declaration_explicit_inequality_join[
            "summary_transparent_declarations"], int)
            or isinstance(transparent_declaration_explicit_inequality_join[
                "summary_transparent_declarations"], bool)
            or not isinstance(transparent_declaration_explicit_inequality_join[
                "summary_transparent_explicit_value"], int)
            or isinstance(transparent_declaration_explicit_inequality_join[
                "summary_transparent_explicit_value"], bool)
            or transparent_declaration_explicit_inequality_join[
                "summary_transparent_declarations"]
            <= transparent_declaration_explicit_inequality_join[
                "summary_transparent_explicit_value"]):
        raise SystemExit(
            "REFUSE: facade manifest transparent-declaration count must exceed "
            f"explicit-value count ({json.dumps(transparent_declaration_explicit_inequality_join, sort_keys=True)})"
        )
    roundtrip_explicit_value_inequality_join = {
        "summary_type_roundtrip_checked": manifest_summary.get(
            "type_roundtrip_checked"
        ),
        "summary_transparent_explicit_value": manifest_summary.get(
    ...
    if (not isinstance(roundtrip_explicit_value_inequality_join[
            "summary_type_roundtrip_checked"], int)
            or isinstance(roundtrip_explicit_value_inequality_join[
                "summary_type_roundtrip_checked"], bool)
            or not isinstance(roundtrip_explicit_value_inequality_join[
                "summary_transparent_explicit_value"], int)
            or isinstance(roundtrip_explicit_value_inequality_join[
                "summary_transparent_explicit_value"], bool)
            or roundtrip_explicit_value_inequality_join[
                "summary_type_roundtrip_checked"]
            <= roundtrip_explicit_value_inequality_join[
                "summary_transparent_explicit_value"]):
        raise SystemExit(
            "REFUSE: facade manifest roundtrip count must exceed explicit "
            f"value count ({json.dumps(roundtrip_explicit_value_inequality_join, sort_keys=True)})"
        )
    ...
    if (not isinstance(class_projection_substrate_inequality_join[
            "summary_class_provided_projections"], int)
            or isinstance(class_projection_substrate_inequality_join[
                "summary_class_provided_projections"], bool)
            or not isinstance(class_projection_substrate_inequality_join[
                "summary_substrate_emitted"], int)
            or isinstance(class_projection_substrate_inequality_join[
                "summary_substrate_emitted"], bool)
            or class_projection_substrate_inequality_join[
                "summary_class_provided_projections"]
            <= class_projection_substrate_inequality_join[
                "summary_substrate_emitted"]):
        raise SystemExit(
    ...
    if (not isinstance(emitted_demand_init_substrate_inequality_join[
            "summary_demanded_emitted"], int)
            or isinstance(emitted_demand_init_substrate_inequality_join[
                "summary_demanded_emitted"], bool)
            or not isinstance(emitted_demand_init_substrate_inequality_join[
                "summary_demanded_init_substrate"], int)
            or isinstance(emitted_demand_init_substrate_inequality_join[
                "summary_demanded_init_substrate"], bool)
            or emitted_demand_init_substrate_inequality_join[
    ...
    declaration_roundtrip_inequality_join = {
        "summary_declarations_emitted": manifest_summary.get(
            "declarations_emitted"
        ),
        "summary_type_roundtrip_checked": manifest_summary.get(
    ...
    if (not isinstance(declaration_roundtrip_inequality_join[
            "summary_declarations_emitted"], int)
            or isinstance(declaration_roundtrip_inequality_join[
                "summary_declarations_emitted"], bool)
            or not isinstance(declaration_roundtrip_inequality_join[
                "summary_type_roundtrip_checked"], int)
            or isinstance(declaration_roundtrip_inequality_join[
                "summary_type_roundtrip_checked"], bool)
            or declaration_roundtrip_inequality_join[
                "summary_declarations_emitted"]
            <= declaration_roundtrip_inequality_join[
                "summary_type_roundtrip_checked"]):
        raise SystemExit(
            "REFUSE: facade manifest declaration count must exceed type "
            f"roundtrip count ({json.dumps(declaration_roundtrip_inequality_join, sort_keys=True)})"
        )
    projection_explicit_value_inequality_join = {
        "summary_projection_types_checked": manifest_summary.get(
            "projection_types_checked"
        ),
        "summary_transparent_explicit_value": manifest_summary.get(
    ...
    if (not isinstance(projection_explicit_value_inequality_join[
            "summary_projection_types_checked"], int)
            or isinstance(projection_explicit_value_inequality_join[
                "summary_projection_types_checked"], bool)
            or not isinstance(projection_explicit_value_inequality_join[
                "summary_transparent_explicit_value"], int)
            or isinstance(projection_explicit_value_inequality_join[
                "summary_transparent_explicit_value"], bool)
            or projection_explicit_value_inequality_join[
                "summary_projection_types_checked"]
            <= projection_explicit_value_inequality_join[
                "summary_transparent_explicit_value"]):
        raise SystemExit(
            "REFUSE: facade manifest projection-type count must exceed explicit "
            f"value count ({json.dumps(projection_explicit_value_inequality_join, sort_keys=True)})"
        )
    ...
    if (not isinstance(roundtrip_transparent_declaration_inequality_join[
            "summary_type_roundtrip_checked"], int)
            or isinstance(roundtrip_transparent_declaration_inequality_join[
                "summary_type_roundtrip_checked"], bool)
            or not isinstance(roundtrip_transparent_declaration_inequality_join[
                "summary_transparent_declarations"], int)
            or isinstance(roundtrip_transparent_declaration_inequality_join[
                "summary_transparent_declarations"], bool)
            or roundtrip_transparent_declaration_inequality_join[
                "summary_type_roundtrip_checked"]
            <= roundtrip_transparent_declaration_inequality_join[
                "summary_transparent_declarations"]):
        raise SystemExit(
    ...
    declaration_transparent_value_inequality_join = {
        "summary_declarations_emitted": manifest_summary.get(
            "declarations_emitted"
        ),
        "summary_transparent_values_checked": manifest_summary.get(
    ...
    if (not isinstance(declaration_transparent_value_inequality_join[
            "summary_declarations_emitted"], int)
            or isinstance(declaration_transparent_value_inequality_join[
                "summary_declarations_emitted"], bool)
            or not isinstance(declaration_transparent_value_inequality_join[
                "summary_transparent_values_checked"], int)
            or isinstance(declaration_transparent_value_inequality_join[
                "summary_transparent_values_checked"], bool)
            or declaration_transparent_value_inequality_join[
                "summary_declarations_emitted"]
            <= declaration_transparent_value_inequality_join[
                "summary_transparent_values_checked"]):
        raise SystemExit(
            "REFUSE: facade manifest declaration count must exceed transparent "
            f"value count ({json.dumps(declaration_transparent_value_inequality_join, sort_keys=True)})"
        )
    declaration_explicit_value_inequality_join = {
        "summary_declarations_emitted": manifest_summary.get(
            "declarations_emitted"
        ),
        "summary_transparent_explicit_value": manifest_summary.get(
    ...
    if (not isinstance(declaration_explicit_value_inequality_join[
            "summary_declarations_emitted"], int)
            or isinstance(declaration_explicit_value_inequality_join[
                "summary_declarations_emitted"], bool)
            or not isinstance(declaration_explicit_value_inequality_join[
                "summary_transparent_explicit_value"], int)
            or isinstance(declaration_explicit_value_inequality_join[
                "summary_transparent_explicit_value"], bool)
            or declaration_explicit_value_inequality_join[
                "summary_declarations_emitted"]
            <= declaration_explicit_value_inequality_join[
                "summary_transparent_explicit_value"]):
        raise SystemExit(
            "REFUSE: facade manifest declaration count must exceed explicit "
            f"value count ({json.dumps(declaration_explicit_value_inequality_join, sort_keys=True)})"
        )
    class_projection_bare_name_inequality_join = {
        "summary_class_provided_projections": manifest_summary.get(
            "class_provided_projections"
        ),
        "summary_bare_names_probed": manifest_summary.get("bare_names_probed"),
    }
    if (not isinstance(class_projection_bare_name_inequality_join[
            "summary_class_provided_projections"], int)
            or isinstance(class_projection_bare_name_inequality_join[
                "summary_class_provided_projections"], bool)
            or not isinstance(class_projection_bare_name_inequality_join[
                "summary_bare_names_probed"], int)
            or isinstance(class_projection_bare_name_inequality_join[
                "summary_bare_names_probed"], bool)
            or class_projection_bare_name_inequality_join[
                "summary_class_provided_projections"]
            <= class_projection_bare_name_inequality_join[
                "summary_bare_names_probed"]):
        raise SystemExit(
            "REFUSE: facade manifest class-projection count must exceed "
            f"bare-name probe count ({json.dumps(class_projection_bare_name_inequality_join, sort_keys=True)})"
        )
    class_projection_roundtrip_inequality_join = {
        "summary_class_provided_projections": manifest_summary.get(
            "class_provided_projections"
        ),
        "summary_type_roundtrip_checked": manifest_summary.get(
    ...
    if (not isinstance(class_projection_roundtrip_inequality_join[
            "summary_class_provided_projections"], int)
            or isinstance(class_projection_roundtrip_inequality_join[
                "summary_class_provided_projections"], bool)
            or not isinstance(class_projection_roundtrip_inequality_join[
                "summary_type_roundtrip_checked"], int)
            or isinstance(class_projection_roundtrip_inequality_join[
                "summary_type_roundtrip_checked"], bool)
            or class_projection_roundtrip_inequality_join[
                "summary_class_provided_projections"]
            <= class_projection_roundtrip_inequality_join[
                "summary_type_roundtrip_checked"]):
        raise SystemExit(
            "REFUSE: facade manifest class-projection count must exceed type "
            f"roundtrip count ({json.dumps(class_projection_roundtrip_inequality_join, sort_keys=True)})"
        )
    class_projection_transparent_inequality_join = {
        "summary_class_provided_projections": manifest_summary.get(
            "class_provided_projections"
        ),
        "summary_transparent_declarations": manifest_summary.get(
    ...
    if (not isinstance(class_projection_transparent_inequality_join[
            "summary_class_provided_projections"], int)
            or isinstance(class_projection_transparent_inequality_join[
                "summary_class_provided_projections"], bool)
            or not isinstance(class_projection_transparent_inequality_join[
                "summary_transparent_declarations"], int)
            or isinstance(class_projection_transparent_inequality_join[
                "summary_transparent_declarations"], bool)
            or class_projection_transparent_inequality_join[
                "summary_class_provided_projections"]
            <= class_projection_transparent_inequality_join[
                "summary_transparent_declarations"]):
        raise SystemExit(
            "REFUSE: facade manifest class-projection count must exceed "
            f"transparent-declaration count ({json.dumps(class_projection_transparent_inequality_join, sort_keys=True)})"
        )
    class_projection_transparent_value_inequality_join = {
        "summary_class_provided_projections": manifest_summary.get(
            "class_provided_projections"
        ),
        "summary_transparent_values_checked": manifest_summary.get(
    ...
    if (not isinstance(class_projection_transparent_value_inequality_join[
            "summary_class_provided_projections"], int)
            or isinstance(class_projection_transparent_value_inequality_join[
                "summary_class_provided_projections"], bool)
            or not isinstance(class_projection_transparent_value_inequality_join[
                "summary_transparent_values_checked"], int)
            or isinstance(class_projection_transparent_value_inequality_join[
                "summary_transparent_values_checked"], bool)
            or class_projection_transparent_value_inequality_join[
                "summary_class_provided_projections"]
            <= class_projection_transparent_value_inequality_join[
                "summary_transparent_values_checked"]):
        raise SystemExit(
            "REFUSE: facade manifest class-projection count must exceed "
            f"transparent-value count ({json.dumps(class_projection_transparent_value_inequality_join, sort_keys=True)})"
        )
    ...
    if (not isinstance(class_projection_explicit_value_inequality_join[
            "summary_class_provided_projections"], int)
            or isinstance(class_projection_explicit_value_inequality_join[
                "summary_class_provided_projections"], bool)
            or not isinstance(class_projection_explicit_value_inequality_join[
                "summary_transparent_explicit_value"], int)
            or isinstance(class_projection_explicit_value_inequality_join[
                "summary_transparent_explicit_value"], bool)
            or class_projection_explicit_value_inequality_join[
                "summary_class_provided_projections"]
            <= class_projection_explicit_value_inequality_join[
                "summary_transparent_explicit_value"]):
        raise SystemExit(
    ...
    projection_emitted_demand_inequality_join = {
        "summary_projection_types_checked": manifest_summary.get(
            "projection_types_checked"
        ),
        "summary_demanded_emitted": manifest_summary.get("demanded_emitted"),
    }
    if (not isinstance(projection_emitted_demand_inequality_join[
            "summary_projection_types_checked"], int)
            or isinstance(projection_emitted_demand_inequality_join[
                "summary_projection_types_checked"], bool)
            or not isinstance(projection_emitted_demand_inequality_join[
                "summary_demanded_emitted"], int)
            or isinstance(projection_emitted_demand_inequality_join[
                "summary_demanded_emitted"], bool)
            or projection_emitted_demand_inequality_join[
                "summary_projection_types_checked"]
            <= projection_emitted_demand_inequality_join[
                "summary_demanded_emitted"]):
        raise SystemExit(
            "REFUSE: facade manifest projection-type count must exceed emitted "
            f"demand count ({json.dumps(projection_emitted_demand_inequality_join, sort_keys=True)})"
        )
    class_projection_demand_inequality_join = {
        "summary_class_provided_projections": manifest_summary.get(
            "class_provided_projections"
        ),
        "summary_demanded": manifest_summary.get("demanded"),
    }
    if (not isinstance(class_projection_demand_inequality_join[
            "summary_class_provided_projections"], int)
            or isinstance(class_projection_demand_inequality_join[
                "summary_class_provided_projections"], bool)
            or not isinstance(class_projection_demand_inequality_join[
                "summary_demanded"], int)
            or isinstance(class_projection_demand_inequality_join[
                "summary_demanded"], bool)
            or class_projection_demand_inequality_join[
                "summary_class_provided_projections"]
            <= class_projection_demand_inequality_join["summary_demanded"]):
        raise SystemExit(
            "REFUSE: facade manifest class-projection count must exceed demand "
            f"count ({json.dumps(class_projection_demand_inequality_join, sort_keys=True)})"
        )
    ...
    if (not isinstance(class_projection_emitted_demand_inequality_join[
            "summary_class_provided_projections"], int)
            or isinstance(class_projection_emitted_demand_inequality_join[
                "summary_class_provided_projections"], bool)
            or not isinstance(class_projection_emitted_demand_inequality_join[
                "summary_demanded_emitted"], int)
            or isinstance(class_projection_emitted_demand_inequality_join[
                "summary_demanded_emitted"], bool)
            or class_projection_emitted_demand_inequality_join[
                "summary_class_provided_projections"]
            <= class_projection_emitted_demand_inequality_join[
                "summary_demanded_emitted"]):
        raise SystemExit(
    ...
    class_projection_kernel_special_inequality_join = {
        "summary_class_provided_projections": manifest_summary.get(
            "class_provided_projections"
        ),
        "summary_kernel_special_population": manifest_summary.get(
    ...
    if (not isinstance(class_projection_kernel_special_inequality_join[
            "summary_class_provided_projections"], int)
            or isinstance(class_projection_kernel_special_inequality_join[
                "summary_class_provided_projections"], bool)
            or not isinstance(class_projection_kernel_special_inequality_join[
                "summary_kernel_special_population"], int)
            or isinstance(class_projection_kernel_special_inequality_join[
                "summary_kernel_special_population"], bool)
            or class_projection_kernel_special_inequality_join[
                "summary_class_provided_projections"]
            <= class_projection_kernel_special_inequality_join[
                "summary_kernel_special_population"]):
        raise SystemExit(
            "REFUSE: facade manifest class-projection count must exceed kernel "
            f"special population ({json.dumps(class_projection_kernel_special_inequality_join, sort_keys=True)})"
        )
    ...
    if (not isinstance(class_projection_structural_declaration_inequality_join[
            "summary_class_provided_projections"], int)
            or isinstance(class_projection_structural_declaration_inequality_join[
                "summary_class_provided_projections"], bool)
            or not isinstance(class_projection_structural_declaration_inequality_join[
                "summary_structural_declarations"], int)
            or isinstance(class_projection_structural_declaration_inequality_join[
                "summary_structural_declarations"], bool)
            or class_projection_structural_declaration_inequality_join[
                "summary_class_provided_projections"]
            <= class_projection_structural_declaration_inequality_join[
    ...
    if (not isinstance(inductive_population_inequality_join[
            "summary_inductive_declarations"], int)
            or isinstance(inductive_population_inequality_join[
                "summary_inductive_declarations"], bool)
            or not isinstance(inductive_population_inequality_join[
                "summary_inductive_refused"], int)
            or isinstance(inductive_population_inequality_join[
                "summary_inductive_refused"], bool)
            or inductive_population_inequality_join[
    ...
    transparent_inductive_inequality_join = {
        "summary_transparent_declarations": manifest_summary.get(
            "transparent_declarations"
        ),
        "summary_inductive_declarations": manifest_summary.get(
    ...
    if (not isinstance(transparent_inductive_inequality_join[
            "summary_transparent_declarations"], int)
            or isinstance(transparent_inductive_inequality_join[
                "summary_transparent_declarations"], bool)
            or not isinstance(transparent_inductive_inequality_join[
                "summary_inductive_declarations"], int)
            or isinstance(transparent_inductive_inequality_join[
                "summary_inductive_declarations"], bool)
            or transparent_inductive_inequality_join[
                "summary_transparent_declarations"]
            <= transparent_inductive_inequality_join[
                "summary_inductive_declarations"]):
        raise SystemExit(
            "REFUSE: facade manifest transparent-declaration count must exceed "
            f"inductive-declaration count ({json.dumps(transparent_inductive_inequality_join, sort_keys=True)})"
        )
    ...
    if (not isinstance(transparent_structural_refusal_inequality_join[
            "summary_transparent_declarations"], int)
            or isinstance(transparent_structural_refusal_inequality_join[
                "summary_transparent_declarations"], bool)
            or not isinstance(transparent_structural_refusal_inequality_join[
                "summary_structural_refused"], int)
            or isinstance(transparent_structural_refusal_inequality_join[
                "summary_structural_refused"], bool)
            or transparent_structural_refusal_inequality_join[
                "summary_transparent_declarations"]
            <= transparent_structural_refusal_inequality_join[
                "summary_structural_refused"]):
        raise SystemExit(
    ...
    if (not isinstance(kernel_special_structural_inequality_join[
            "summary_kernel_special_population"], int)
            or isinstance(kernel_special_structural_inequality_join[
                "summary_kernel_special_population"], bool)
            or not isinstance(kernel_special_structural_inequality_join[
                "summary_structural_declarations"], int)
            or isinstance(kernel_special_structural_inequality_join[
                "summary_structural_declarations"], bool)
            or kernel_special_structural_inequality_join[
                "summary_kernel_special_population"]
            <= kernel_special_structural_inequality_join[
                "summary_structural_declarations"]):
        raise SystemExit(
    ...
    if (not isinstance(kernel_special_structural_refusal_inequality_join[
            "summary_kernel_special_population"], int)
            or isinstance(kernel_special_structural_refusal_inequality_join[
                "summary_kernel_special_population"], bool)
            or not isinstance(kernel_special_structural_refusal_inequality_join[
                "summary_structural_refused"], int)
            or isinstance(kernel_special_structural_refusal_inequality_join[
                "summary_structural_refused"], bool)
            or kernel_special_structural_refusal_inequality_join[
                "summary_kernel_special_population"]
            <= kernel_special_structural_refusal_inequality_join[
                "summary_structural_refused"]):
        raise SystemExit(
    ...
    if (not isinstance(substrate_projection_inequality_join[
            "summary_substrate_emitted"], int)
            or isinstance(substrate_projection_inequality_join[
                "summary_substrate_emitted"], bool)
            or not isinstance(substrate_projection_inequality_join[
                "summary_projection_types_checked"], int)
            or isinstance(substrate_projection_inequality_join[
                "summary_projection_types_checked"], bool)
            or substrate_projection_inequality_join["summary_substrate_emitted"]
            <= substrate_projection_inequality_join[
                "summary_projection_types_checked"]):
        raise SystemExit(
            "REFUSE: facade manifest substrate-emission count must exceed "
    ...
    class_projection_emission_verification_inequality_join = {
        "summary_class_provided_projections": manifest_summary.get(
            "class_provided_projections"
        ),
        "summary_emission_verified": manifest_summary.get("emission_verified"),
    }
    if (not isinstance(class_projection_emission_verification_inequality_join[
            "summary_class_provided_projections"], int)
            or isinstance(class_projection_emission_verification_inequality_join[
                "summary_class_provided_projections"], bool)
            or not isinstance(class_projection_emission_verification_inequality_join[
                "summary_emission_verified"], int)
            or isinstance(class_projection_emission_verification_inequality_join[
                "summary_emission_verified"], bool)
            or class_projection_emission_verification_inequality_join[
                "summary_class_provided_projections"]
            <= class_projection_emission_verification_inequality_join[
                "summary_emission_verified"]):
        raise SystemExit(
            "REFUSE: facade manifest class-projection count must exceed "
            f"emission-verification count ({json.dumps(class_projection_emission_verification_inequality_join, sort_keys=True)})"
        )
    demanded_facade_inequality_join = {
        "summary_demanded": manifest_summary.get("demanded"),
        "summary_facade_demand": manifest_summary.get("facade_demand"),
    }
    if (not isinstance(demanded_facade_inequality_join["summary_demanded"], int)
            or isinstance(demanded_facade_inequality_join[
                "summary_demanded"], bool)
            or not isinstance(demanded_facade_inequality_join[
                "summary_facade_demand"], int)
            or isinstance(demanded_facade_inequality_join[
                "summary_facade_demand"], bool)
            or demanded_facade_inequality_join["summary_demanded"]
            <= demanded_facade_inequality_join["summary_facade_demand"]):
        raise SystemExit(
            "REFUSE: facade manifest demanded count must exceed facade-demand "
            f"count ({json.dumps(demanded_facade_inequality_join, sort_keys=True)})"
        )
    ...
    if (not isinstance(roundtrip_kernel_special_inequality_join[
            "summary_type_roundtrip_checked"], int)
            or isinstance(roundtrip_kernel_special_inequality_join[
                "summary_type_roundtrip_checked"], bool)
            or not isinstance(roundtrip_kernel_special_inequality_join[
                "summary_kernel_special_population"], int)
            or isinstance(roundtrip_kernel_special_inequality_join[
                "summary_kernel_special_population"], bool)
            or roundtrip_kernel_special_inequality_join[
                "summary_type_roundtrip_checked"]
            <= roundtrip_kernel_special_inequality_join[
                "summary_kernel_special_population"]):
        raise SystemExit(
    ...
    if (not isinstance(projection_kernel_special_inequality_join[
            "summary_projection_types_checked"], int)
            or isinstance(projection_kernel_special_inequality_join[
                "summary_projection_types_checked"], bool)
            or not isinstance(projection_kernel_special_inequality_join[
                "summary_kernel_special_population"], int)
            or isinstance(projection_kernel_special_inequality_join[
                "summary_kernel_special_population"], bool)
            or projection_kernel_special_inequality_join[
                "summary_projection_types_checked"]
            <= projection_kernel_special_inequality_join[
                "summary_kernel_special_population"]):
        raise SystemExit(
    ...
    if (not isinstance(emission_kernel_special_inequality_join[
            "summary_emission_verified"], int)
            or isinstance(emission_kernel_special_inequality_join[
                "summary_emission_verified"], bool)
            or not isinstance(emission_kernel_special_inequality_join[
                "summary_kernel_special_population"], int)
            or isinstance(emission_kernel_special_inequality_join[
                "summary_kernel_special_population"], bool)
            or emission_kernel_special_inequality_join[
                "summary_emission_verified"]
            <= emission_kernel_special_inequality_join[
                "summary_kernel_special_population"]):
        raise SystemExit(
    ...
    if (not isinstance(emission_roundtrip_inequality_join[
            "summary_emission_verified"], int)
            or isinstance(emission_roundtrip_inequality_join[
                "summary_emission_verified"], bool)
            or not isinstance(emission_roundtrip_inequality_join[
                "summary_type_roundtrip_checked"], int)
            or isinstance(emission_roundtrip_inequality_join[
                "summary_type_roundtrip_checked"], bool)
            or emission_roundtrip_inequality_join["summary_emission_verified"]
            <= emission_roundtrip_inequality_join[
                "summary_type_roundtrip_checked"]):
        raise SystemExit(
            "REFUSE: facade manifest emission-verification count must exceed "
    ...
    emission_structural_inequality_join = {
        "summary_emission_verified": manifest_summary.get("emission_verified"),
        "summary_structural_declarations": manifest_summary.get(
            "structural_declarations"
        ),
    }
    if (not isinstance(emission_structural_inequality_join[
            "summary_emission_verified"], int)
            or isinstance(emission_structural_inequality_join[
                "summary_emission_verified"], bool)
            or not isinstance(emission_structural_inequality_join[
                "summary_structural_declarations"], int)
            or isinstance(emission_structural_inequality_join[
                "summary_structural_declarations"], bool)
            or emission_structural_inequality_join["summary_emission_verified"]
            <= emission_structural_inequality_join[
                "summary_structural_declarations"]):
        raise SystemExit(
            "REFUSE: facade manifest emission-verification count must exceed "
            f"structural-declaration count ({json.dumps(emission_structural_inequality_join, sort_keys=True)})"
        )
    ...
    if (not isinstance(emission_inductive_inequality_join[
            "summary_emission_verified"], int)
            or isinstance(emission_inductive_inequality_join[
                "summary_emission_verified"], bool)
            or not isinstance(emission_inductive_inequality_join[
                "summary_inductive_declarations"], int)
            or isinstance(emission_inductive_inequality_join[
                "summary_inductive_declarations"], bool)
            or emission_inductive_inequality_join["summary_emission_verified"]
            <= emission_inductive_inequality_join[
                "summary_inductive_declarations"]):
        raise SystemExit(
            "REFUSE: facade manifest emission-verification count must exceed "
    ...
    if (not isinstance(declaration_structural_refusal_inequality_join[
            "summary_declarations_emitted"], int)
            or isinstance(declaration_structural_refusal_inequality_join[
                "summary_declarations_emitted"], bool)
            or not isinstance(declaration_structural_refusal_inequality_join[
                "summary_structural_refused"], int)
            or isinstance(declaration_structural_refusal_inequality_join[
                "summary_structural_refused"], bool)
            or declaration_structural_refusal_inequality_join[
                "summary_declarations_emitted"]
            <= declaration_structural_refusal_inequality_join[
                "summary_structural_refused"]):
        raise SystemExit(
    ...
    if (not isinstance(emission_inductive_refusal_inequality_join[
            "summary_emission_verified"], int)
            or isinstance(emission_inductive_refusal_inequality_join[
                "summary_emission_verified"], bool)
            or not isinstance(emission_inductive_refusal_inequality_join[
                "summary_inductive_refused"], int)
            or isinstance(emission_inductive_refusal_inequality_join[
                "summary_inductive_refused"], bool)
            or emission_inductive_refusal_inequality_join[
                "summary_emission_verified"]
            <= emission_inductive_refusal_inequality_join[
                "summary_inductive_refused"]):
        raise SystemExit(
    ...
    substrate_structural_inequality_join = {
        "summary_substrate_emitted": manifest_summary.get("substrate_emitted"),
        "summary_structural_declarations": manifest_summary.get(
            "structural_declarations"
        ),
    }
    if (not isinstance(substrate_structural_inequality_join[
            "summary_substrate_emitted"], int)
            or isinstance(substrate_structural_inequality_join[
                "summary_substrate_emitted"], bool)
            or not isinstance(substrate_structural_inequality_join[
                "summary_structural_declarations"], int)
            or isinstance(substrate_structural_inequality_join[
                "summary_structural_declarations"], bool)
            or substrate_structural_inequality_join["summary_substrate_emitted"]
            <= substrate_structural_inequality_join[
                "summary_structural_declarations"]):
        raise SystemExit(
            "REFUSE: facade manifest substrate-emission count must exceed "
            f"structural-declaration count ({json.dumps(substrate_structural_inequality_join, sort_keys=True)})"
        )
    substrate_inductive_inequality_join = {
        "summary_substrate_emitted": manifest_summary.get("substrate_emitted"),
        "summary_inductive_declarations": manifest_summary.get(
            "inductive_declarations"
        ),
    }
    if (not isinstance(substrate_inductive_inequality_join[
            "summary_substrate_emitted"], int)
            or isinstance(substrate_inductive_inequality_join[
                "summary_substrate_emitted"], bool)
            or not isinstance(substrate_inductive_inequality_join[
                "summary_inductive_declarations"], int)
            or isinstance(substrate_inductive_inequality_join[
                "summary_inductive_declarations"], bool)
            or substrate_inductive_inequality_join["summary_substrate_emitted"]
            <= substrate_inductive_inequality_join[
                "summary_inductive_declarations"]):
        raise SystemExit(
            "REFUSE: facade manifest substrate-emission count must exceed "
            f"inductive-declaration count ({json.dumps(substrate_inductive_inequality_join, sort_keys=True)})"
        )
    substrate_structural_refusal_inequality_join = {
        "summary_substrate_emitted": manifest_summary.get("substrate_emitted"),
        "summary_structural_refused": manifest_summary.get("structural_refused"),
    }
    if (not isinstance(substrate_structural_refusal_inequality_join[
            "summary_substrate_emitted"], int)
            or isinstance(substrate_structural_refusal_inequality_join[
                "summary_substrate_emitted"], bool)
            or not isinstance(substrate_structural_refusal_inequality_join[
                "summary_structural_refused"], int)
            or isinstance(substrate_structural_refusal_inequality_join[
                "summary_structural_refused"], bool)
            or substrate_structural_refusal_inequality_join[
                "summary_substrate_emitted"]
            <= substrate_structural_refusal_inequality_join[
                "summary_structural_refused"]):
        raise SystemExit(
            "REFUSE: facade manifest substrate-emission count must exceed "
            f"structural-refusal count ({json.dumps(substrate_structural_refusal_inequality_join, sort_keys=True)})"
        )
    substrate_inductive_refusal_inequality_join = {
        "summary_substrate_emitted": manifest_summary.get("substrate_emitted"),
        "summary_inductive_refused": manifest_summary.get("inductive_refused"),
    }
    if (not isinstance(substrate_inductive_refusal_inequality_join[
            "summary_substrate_emitted"], int)
            or isinstance(substrate_inductive_refusal_inequality_join[
                "summary_substrate_emitted"], bool)
            or not isinstance(substrate_inductive_refusal_inequality_join[
                "summary_inductive_refused"], int)
            or isinstance(substrate_inductive_refusal_inequality_join[
                "summary_inductive_refused"], bool)
            or substrate_inductive_refusal_inequality_join[
                "summary_substrate_emitted"]
            <= substrate_inductive_refusal_inequality_join[
                "summary_inductive_refused"]):
        raise SystemExit(
            "REFUSE: facade manifest substrate-emission count must exceed "
            f"inductive-refusal count ({json.dumps(substrate_inductive_refusal_inequality_join, sort_keys=True)})"
        )
    ...
    if (not isinstance(projection_structural_refusal_inequality_join[
            "summary_projection_types_checked"], int)
            or isinstance(projection_structural_refusal_inequality_join[
                "summary_projection_types_checked"], bool)
            or not isinstance(projection_structural_refusal_inequality_join[
                "summary_structural_refused"], int)
            or isinstance(projection_structural_refusal_inequality_join[
                "summary_structural_refused"], bool)
            or projection_structural_refusal_inequality_join[
                "summary_projection_types_checked"]
            <= projection_structural_refusal_inequality_join[
                "summary_structural_refused"]):
        raise SystemExit(
    ...
    if (not isinstance(field_set_structural_refusal_inequality_join[
            "summary_field_sets_checked"], int)
            or isinstance(field_set_structural_refusal_inequality_join[
                "summary_field_sets_checked"], bool)
            or not isinstance(field_set_structural_refusal_inequality_join[
                "summary_structural_refused"], int)
            or isinstance(field_set_structural_refusal_inequality_join[
                "summary_structural_refused"], bool)
            or field_set_structural_refusal_inequality_join[
                "summary_field_sets_checked"]
            <= field_set_structural_refusal_inequality_join[
                "summary_structural_refused"]):
        raise SystemExit(
    ...
    class_projection_structural_refusal_inequality_join = {
        "summary_class_provided_projections": manifest_summary.get("class_provided_projections"),
        "summary_structural_refused": manifest_summary.get("structural_refused"),
    }
    if (not isinstance(class_projection_structural_refusal_inequality_join["summary_class_provided_projections"], int)
            or isinstance(class_projection_structural_refusal_inequality_join["summary_class_provided_projections"], bool)
            or not isinstance(class_projection_structural_refusal_inequality_join["summary_structural_refused"], int)
            or isinstance(class_projection_structural_refusal_inequality_join["summary_structural_refused"], bool)
            or class_projection_structural_refusal_inequality_join["summary_class_provided_projections"] <= class_projection_structural_refusal_inequality_join["summary_structural_refused"]):
        raise SystemExit("REFUSE: facade manifest class-projection count must exceed structural-refusal count " + json.dumps(class_projection_structural_refusal_inequality_join, sort_keys=True))
    ...
    class_projection_private_field_inequality_join = {"summary_class_provided_projections": manifest_summary.get("class_provided_projections"), "summary_private_fields_exposed": manifest_summary.get("private_fields_exposed")}
    if (not isinstance(class_projection_private_field_inequality_join["summary_class_provided_projections"], int) or isinstance(class_projection_private_field_inequality_join["summary_class_provided_projections"], bool) or not isinstance(class_projection_private_field_inequality_join["summary_private_fields_exposed"], int) or isinstance(class_projection_private_field_inequality_join["summary_private_fields_exposed"], bool) or class_projection_private_field_inequality_join["summary_class_provided_projections"] <= class_projection_private_field_inequality_join["summary_private_fields_exposed"]):
        raise SystemExit("REFUSE: facade manifest class-projection count must exceed private-field count " + json.dumps(class_projection_private_field_inequality_join, sort_keys=True))
    ...
    transparent_quarantine_inequality_join = {"summary_transparent_declarations": manifest_summary.get("transparent_declarations"), "summary_quarantined": manifest_summary.get("quarantined")}
    if (not isinstance(transparent_quarantine_inequality_join["summary_transparent_declarations"], int) or isinstance(transparent_quarantine_inequality_join["summary_transparent_declarations"], bool) or not isinstance(transparent_quarantine_inequality_join["summary_quarantined"], int) or isinstance(transparent_quarantine_inequality_join["summary_quarantined"], bool) or transparent_quarantine_inequality_join["summary_transparent_declarations"] <= transparent_quarantine_inequality_join["summary_quarantined"]):
        raise SystemExit("REFUSE: facade manifest transparent-declaration count must exceed quarantine count " + json.dumps(transparent_quarantine_inequality_join, sort_keys=True))
    roundtrip_quarantine_inequality_join = {"summary_type_roundtrip_checked": manifest_summary.get("type_roundtrip_checked"), "summary_quarantined": manifest_summary.get("quarantined")}
    if (not isinstance(roundtrip_quarantine_inequality_join["summary_type_roundtrip_checked"], int) or isinstance(roundtrip_quarantine_inequality_join["summary_type_roundtrip_checked"], bool) or not isinstance(roundtrip_quarantine_inequality_join["summary_quarantined"], int) or isinstance(roundtrip_quarantine_inequality_join["summary_quarantined"], bool) or roundtrip_quarantine_inequality_join["summary_type_roundtrip_checked"] <= roundtrip_quarantine_inequality_join["summary_quarantined"]):
        raise SystemExit("REFUSE: facade manifest type-roundtrip count must exceed quarantine count " + json.dumps(roundtrip_quarantine_inequality_join, sort_keys=True))
    ...
    emission_init_provided_inequality_join = {"summary_emission_verified": manifest_summary.get("emission_verified"), "summary_init_provided": manifest_summary.get("init_provided")}
    if (not isinstance(emission_init_provided_inequality_join["summary_emission_verified"], int) or isinstance(emission_init_provided_inequality_join["summary_emission_verified"], bool) or not isinstance(emission_init_provided_inequality_join["summary_init_provided"], int) or isinstance(emission_init_provided_inequality_join["summary_init_provided"], bool) or emission_init_provided_inequality_join["summary_emission_verified"] <= emission_init_provided_inequality_join["summary_init_provided"]):
        raise SystemExit("REFUSE: facade manifest emission-verification count must exceed Init-provided count " + json.dumps(emission_init_provided_inequality_join, sort_keys=True))
    ...
    substrate_init_provided_inequality_join = {"summary_substrate_emitted": manifest_summary.get("substrate_emitted"), "summary_init_provided": manifest_summary.get("init_provided")}
    if (not isinstance(substrate_init_provided_inequality_join["summary_substrate_emitted"], int) or isinstance(substrate_init_provided_inequality_join["summary_substrate_emitted"], bool) or not isinstance(substrate_init_provided_inequality_join["summary_init_provided"], int) or isinstance(substrate_init_provided_inequality_join["summary_init_provided"], bool) or substrate_init_provided_inequality_join["summary_substrate_emitted"] <= substrate_init_provided_inequality_join["summary_init_provided"]):
        raise SystemExit("REFUSE: facade manifest substrate-emission count must exceed Init-provided count " + json.dumps(substrate_init_provided_inequality_join, sort_keys=True))
    ...
    init_provided_structural_class_inequality_join = {"summary_init_provided": manifest_summary.get("init_provided"), "summary_structural_class": manifest_summary.get("structural_class")}
    if (not isinstance(init_provided_structural_class_inequality_join["summary_init_provided"], int) or isinstance(init_provided_structural_class_inequality_join["summary_init_provided"], bool) or not isinstance(init_provided_structural_class_inequality_join["summary_structural_class"], int) or isinstance(init_provided_structural_class_inequality_join["summary_structural_class"], bool) or init_provided_structural_class_inequality_join["summary_init_provided"] <= init_provided_structural_class_inequality_join["summary_structural_class"]):
        raise SystemExit("REFUSE: facade manifest Init-provided count must exceed structural-class count " + json.dumps(init_provided_structural_class_inequality_join, sort_keys=True))
    demanded_init_substrate_private_names_inequality_join = {"summary_demanded_init_substrate": manifest_summary.get("demanded_init_substrate"), "summary_private_name_rows": manifest_summary.get("private_name_rows")}
    if (not isinstance(demanded_init_substrate_private_names_inequality_join["summary_demanded_init_substrate"], int) or isinstance(demanded_init_substrate_private_names_inequality_join["summary_demanded_init_substrate"], bool) or not isinstance(demanded_init_substrate_private_names_inequality_join["summary_private_name_rows"], int) or isinstance(demanded_init_substrate_private_names_inequality_join["summary_private_name_rows"], bool) or demanded_init_substrate_private_names_inequality_join["summary_demanded_init_substrate"] <= demanded_init_substrate_private_names_inequality_join["summary_private_name_rows"]):
        raise SystemExit("REFUSE: facade manifest demanded Init-substrate count must exceed private-name row count " + json.dumps(demanded_init_substrate_private_names_inequality_join, sort_keys=True))
    demanded_init_substrate_structural_refused_inequality_join = {"summary_demanded_init_substrate": manifest_summary.get("demanded_init_substrate"), "summary_structural_refused": manifest_summary.get("structural_refused")}
    if (not isinstance(demanded_init_substrate_structural_refused_inequality_join["summary_demanded_init_substrate"], int) or isinstance(demanded_init_substrate_structural_refused_inequality_join["summary_demanded_init_substrate"], bool) or not isinstance(demanded_init_substrate_structural_refused_inequality_join["summary_structural_refused"], int) or isinstance(demanded_init_substrate_structural_refused_inequality_join["summary_structural_refused"], bool) or demanded_init_substrate_structural_refused_inequality_join["summary_demanded_init_substrate"] <= demanded_init_substrate_structural_refused_inequality_join["summary_structural_refused"]):
        raise SystemExit("REFUSE: facade manifest demanded Init-substrate count must exceed structural-refusal count " + json.dumps(demanded_init_substrate_structural_refused_inequality_join, sort_keys=True))
    demanded_init_substrate_structural_class_inequality_join = {"summary_demanded_init_substrate": manifest_summary.get("demanded_init_substrate"), "summary_structural_class": manifest_summary.get("structural_class")}
    if (not isinstance(demanded_init_substrate_structural_class_inequality_join["summary_demanded_init_substrate"], int) or isinstance(demanded_init_substrate_structural_class_inequality_join["summary_demanded_init_substrate"], bool) or not isinstance(demanded_init_substrate_structural_class_inequality_join["summary_structural_class"], int) or isinstance(demanded_init_substrate_structural_class_inequality_join["summary_structural_class"], bool) or demanded_init_substrate_structural_class_inequality_join["summary_demanded_init_substrate"] <= demanded_init_substrate_structural_class_inequality_join["summary_structural_class"]):
        raise SystemExit("REFUSE: facade manifest demanded Init-substrate count must exceed structural-class count " + json.dumps(demanded_init_substrate_structural_class_inequality_join, sort_keys=True))
    demanded_init_substrate_inductive_refused_inequality_join = {"summary_demanded_init_substrate": manifest_summary.get("demanded_init_substrate"), "summary_inductive_refused": manifest_summary.get("inductive_refused")}
    if (not isinstance(demanded_init_substrate_inductive_refused_inequality_join["summary_demanded_init_substrate"], int) or isinstance(demanded_init_substrate_inductive_refused_inequality_join["summary_demanded_init_substrate"], bool) or not isinstance(demanded_init_substrate_inductive_refused_inequality_join["summary_inductive_refused"], int) or isinstance(demanded_init_substrate_inductive_refused_inequality_join["summary_inductive_refused"], bool) or demanded_init_substrate_inductive_refused_inequality_join["summary_demanded_init_substrate"] <= demanded_init_substrate_inductive_refused_inequality_join["summary_inductive_refused"]):
        raise SystemExit("REFUSE: facade manifest demanded Init-substrate count must exceed inductive-refusal count " + json.dumps(demanded_init_substrate_inductive_refused_inequality_join, sort_keys=True))
    ...
    transparent_declarations_demanded_emitted_inequality_join = {"summary_transparent_declarations": manifest_summary.get("transparent_declarations"), "summary_demanded_emitted": manifest_summary.get("demanded_emitted")}
    if (not isinstance(transparent_declarations_demanded_emitted_inequality_join["summary_transparent_declarations"], int) or isinstance(transparent_declarations_demanded_emitted_inequality_join["summary_transparent_declarations"], bool) or not isinstance(transparent_declarations_demanded_emitted_inequality_join["summary_demanded_emitted"], int) or isinstance(transparent_declarations_demanded_emitted_inequality_join["summary_demanded_emitted"], bool) or transparent_declarations_demanded_emitted_inequality_join["summary_transparent_declarations"] <= transparent_declarations_demanded_emitted_inequality_join["summary_demanded_emitted"]):
        raise SystemExit("REFUSE: facade manifest transparent-declaration count must exceed emitted-demand count " + json.dumps(transparent_declarations_demanded_emitted_inequality_join, sort_keys=True))
    ...
    projection_types_init_provided_inequality_join = {"summary_projection_types_checked": manifest_summary.get("projection_types_checked"), "summary_init_provided": manifest_summary.get("init_provided")}
    if (not isinstance(projection_types_init_provided_inequality_join["summary_projection_types_checked"], int) or isinstance(projection_types_init_provided_inequality_join["summary_projection_types_checked"], bool) or not isinstance(projection_types_init_provided_inequality_join["summary_init_provided"], int) or isinstance(projection_types_init_provided_inequality_join["summary_init_provided"], bool) or projection_types_init_provided_inequality_join["summary_projection_types_checked"] <= projection_types_init_provided_inequality_join["summary_init_provided"]):
        raise SystemExit("REFUSE: facade manifest projection-type count must exceed Init-provided count " + json.dumps(projection_types_init_provided_inequality_join, sort_keys=True))
    type_roundtrip_demanded_emitted_inequality_join = {"summary_type_roundtrip_checked": manifest_summary.get("type_roundtrip_checked"), "summary_demanded_emitted": manifest_summary.get("demanded_emitted")}
    if (not isinstance(type_roundtrip_demanded_emitted_inequality_join["summary_type_roundtrip_checked"], int) or isinstance(type_roundtrip_demanded_emitted_inequality_join["summary_type_roundtrip_checked"], bool) or not isinstance(type_roundtrip_demanded_emitted_inequality_join["summary_demanded_emitted"], int) or isinstance(type_roundtrip_demanded_emitted_inequality_join["summary_demanded_emitted"], bool) or type_roundtrip_demanded_emitted_inequality_join["summary_type_roundtrip_checked"] <= type_roundtrip_demanded_emitted_inequality_join["summary_demanded_emitted"]):
        raise SystemExit("REFUSE: facade manifest type-roundtrip count must exceed emitted-demand count " + json.dumps(type_roundtrip_demanded_emitted_inequality_join, sort_keys=True))
    type_roundtrip_init_provided_inequality_join = {"summary_type_roundtrip_checked": manifest_summary.get("type_roundtrip_checked"), "summary_init_provided": manifest_summary.get("init_provided")}
    if (not isinstance(type_roundtrip_init_provided_inequality_join["summary_type_roundtrip_checked"], int) or isinstance(type_roundtrip_init_provided_inequality_join["summary_type_roundtrip_checked"], bool) or not isinstance(type_roundtrip_init_provided_inequality_join["summary_init_provided"], int) or isinstance(type_roundtrip_init_provided_inequality_join["summary_init_provided"], bool) or type_roundtrip_init_provided_inequality_join["summary_type_roundtrip_checked"] <= type_roundtrip_init_provided_inequality_join["summary_init_provided"]):
        raise SystemExit("REFUSE: facade manifest type-roundtrip count must exceed Init-provided count " + json.dumps(type_roundtrip_init_provided_inequality_join, sort_keys=True))
    type_roundtrip_demanded_init_substrate_inequality_join = {"summary_type_roundtrip_checked": manifest_summary.get("type_roundtrip_checked"), "summary_demanded_init_substrate": manifest_summary.get("demanded_init_substrate")}
    if (not isinstance(type_roundtrip_demanded_init_substrate_inequality_join["summary_type_roundtrip_checked"], int) or isinstance(type_roundtrip_demanded_init_substrate_inequality_join["summary_type_roundtrip_checked"], bool) or not isinstance(type_roundtrip_demanded_init_substrate_inequality_join["summary_demanded_init_substrate"], int) or isinstance(type_roundtrip_demanded_init_substrate_inequality_join["summary_demanded_init_substrate"], bool) or type_roundtrip_demanded_init_substrate_inequality_join["summary_type_roundtrip_checked"] <= type_roundtrip_demanded_init_substrate_inequality_join["summary_demanded_init_substrate"]):
        raise SystemExit("REFUSE: facade manifest type-roundtrip count must exceed demanded Init-substrate count " + json.dumps(type_roundtrip_demanded_init_substrate_inequality_join, sort_keys=True))
    ...
    type_roundtrip_private_names_inequality_join = {"summary_type_roundtrip_checked": manifest_summary.get("type_roundtrip_checked"), "summary_private_name_rows": manifest_summary.get("private_name_rows")}
    if (not isinstance(type_roundtrip_private_names_inequality_join["summary_type_roundtrip_checked"], int) or isinstance(type_roundtrip_private_names_inequality_join["summary_type_roundtrip_checked"], bool) or not isinstance(type_roundtrip_private_names_inequality_join["summary_private_name_rows"], int) or isinstance(type_roundtrip_private_names_inequality_join["summary_private_name_rows"], bool) or type_roundtrip_private_names_inequality_join["summary_type_roundtrip_checked"] <= type_roundtrip_private_names_inequality_join["summary_private_name_rows"]):
        raise SystemExit("REFUSE: facade manifest type-roundtrip count must exceed private-name row count " + json.dumps(type_roundtrip_private_names_inequality_join, sort_keys=True))
    projection_types_private_names_inequality_join = {"summary_projection_types_checked": manifest_summary.get("projection_types_checked"), "summary_private_name_rows": manifest_summary.get("private_name_rows")}
    if (not isinstance(projection_types_private_names_inequality_join["summary_projection_types_checked"], int) or isinstance(projection_types_private_names_inequality_join["summary_projection_types_checked"], bool) or not isinstance(projection_types_private_names_inequality_join["summary_private_name_rows"], int) or isinstance(projection_types_private_names_inequality_join["summary_private_name_rows"], bool) or projection_types_private_names_inequality_join["summary_projection_types_checked"] <= projection_types_private_names_inequality_join["summary_private_name_rows"]):
        raise SystemExit("REFUSE: facade manifest projection-type count must exceed private-name row count " + json.dumps(projection_types_private_names_inequality_join, sort_keys=True))
    ...
    private_names_inductive_refused_inequality_join = {"summary_private_name_rows": manifest_summary.get("private_name_rows"), "summary_inductive_refused": manifest_summary.get("inductive_refused")}
    if (not isinstance(private_names_inductive_refused_inequality_join["summary_private_name_rows"], int) or isinstance(private_names_inductive_refused_inequality_join["summary_private_name_rows"], bool) or not isinstance(private_names_inductive_refused_inequality_join["summary_inductive_refused"], int) or isinstance(private_names_inductive_refused_inequality_join["summary_inductive_refused"], bool) or private_names_inductive_refused_inequality_join["summary_private_name_rows"] <= private_names_inductive_refused_inequality_join["summary_inductive_refused"]):
        raise SystemExit("REFUSE: facade manifest private-name row count must exceed inductive-refusal count " + json.dumps(private_names_inductive_refused_inequality_join, sort_keys=True))
    ...
    type_roundtrip_field_sets_inequality_join = {"summary_type_roundtrip_checked": manifest_summary.get("type_roundtrip_checked"), "summary_field_sets_checked": manifest_summary.get("field_sets_checked")}
    if (not isinstance(type_roundtrip_field_sets_inequality_join["summary_type_roundtrip_checked"], int) or isinstance(type_roundtrip_field_sets_inequality_join["summary_type_roundtrip_checked"], bool) or not isinstance(type_roundtrip_field_sets_inequality_join["summary_field_sets_checked"], int) or isinstance(type_roundtrip_field_sets_inequality_join["summary_field_sets_checked"], bool) or type_roundtrip_field_sets_inequality_join["summary_type_roundtrip_checked"] <= type_roundtrip_field_sets_inequality_join["summary_field_sets_checked"]):
        raise SystemExit("REFUSE: facade manifest type-roundtrip count must exceed field-set count " + json.dumps(type_roundtrip_field_sets_inequality_join, sort_keys=True))
    projection_types_demanded_init_substrate_inequality_join = {"summary_projection_types_checked": manifest_summary.get("projection_types_checked"), "summary_demanded_init_substrate": manifest_summary.get("demanded_init_substrate")}
    if (not isinstance(projection_types_demanded_init_substrate_inequality_join["summary_projection_types_checked"], int) or isinstance(projection_types_demanded_init_substrate_inequality_join["summary_projection_types_checked"], bool) or not isinstance(projection_types_demanded_init_substrate_inequality_join["summary_demanded_init_substrate"], int) or isinstance(projection_types_demanded_init_substrate_inequality_join["summary_demanded_init_substrate"], bool) or projection_types_demanded_init_substrate_inequality_join["summary_projection_types_checked"] <= projection_types_demanded_init_substrate_inequality_join["summary_demanded_init_substrate"]):
        raise SystemExit("REFUSE: facade manifest projection-type count must exceed demanded Init-substrate count " + json.dumps(projection_types_demanded_init_substrate_inequality_join, sort_keys=True))
    transparent_declarations_demanded_init_substrate_inequality_join = {"summary_transparent_declarations": manifest_summary.get("transparent_declarations"), "summary_demanded_init_substrate": manifest_summary.get("demanded_init_substrate")}
    if (not isinstance(transparent_declarations_demanded_init_substrate_inequality_join["summary_transparent_declarations"], int) or isinstance(transparent_declarations_demanded_init_substrate_inequality_join["summary_transparent_declarations"], bool) or not isinstance(transparent_declarations_demanded_init_substrate_inequality_join["summary_demanded_init_substrate"], int) or isinstance(transparent_declarations_demanded_init_substrate_inequality_join["summary_demanded_init_substrate"], bool) or transparent_declarations_demanded_init_substrate_inequality_join["summary_transparent_declarations"] <= transparent_declarations_demanded_init_substrate_inequality_join["summary_demanded_init_substrate"]):
        raise SystemExit("REFUSE: facade manifest transparent-declaration count must exceed demanded Init-substrate count " + json.dumps(transparent_declarations_demanded_init_substrate_inequality_join, sort_keys=True))
    declarations_field_sets_inequality_join = {"summary_declarations_emitted": manifest_summary.get("declarations_emitted"), "summary_field_sets_checked": manifest_summary.get("field_sets_checked")}
    if (not isinstance(declarations_field_sets_inequality_join["summary_declarations_emitted"], int) or isinstance(declarations_field_sets_inequality_join["summary_declarations_emitted"], bool) or not isinstance(declarations_field_sets_inequality_join["summary_field_sets_checked"], int) or isinstance(declarations_field_sets_inequality_join["summary_field_sets_checked"], bool) or declarations_field_sets_inequality_join["summary_declarations_emitted"] <= declarations_field_sets_inequality_join["summary_field_sets_checked"]):
        raise SystemExit("REFUSE: facade manifest declaration count must exceed field-set count " + json.dumps(declarations_field_sets_inequality_join, sort_keys=True))
    ...
    declaration_init_provided_inequality_join = {"summary_declarations_emitted": manifest_summary.get("declarations_emitted"), "summary_init_provided": manifest_summary.get("init_provided")}
    if (not isinstance(declaration_init_provided_inequality_join["summary_declarations_emitted"], int) or isinstance(declaration_init_provided_inequality_join["summary_declarations_emitted"], bool) or not isinstance(declaration_init_provided_inequality_join["summary_init_provided"], int) or isinstance(declaration_init_provided_inequality_join["summary_init_provided"], bool) or declaration_init_provided_inequality_join["summary_declarations_emitted"] <= declaration_init_provided_inequality_join["summary_init_provided"]):
        raise SystemExit("REFUSE: facade manifest declaration count must exceed Init-provided count " + json.dumps(declaration_init_provided_inequality_join, sort_keys=True))
    ...
    kernel_special_demanded_init_substrate_inequality_join = {"summary_kernel_special_population": manifest_summary.get("kernel_special_population"), "summary_demanded_init_substrate": manifest_summary.get("demanded_init_substrate")}
    if (not isinstance(kernel_special_demanded_init_substrate_inequality_join["summary_kernel_special_population"], int) or isinstance(kernel_special_demanded_init_substrate_inequality_join["summary_kernel_special_population"], bool) or not isinstance(kernel_special_demanded_init_substrate_inequality_join["summary_demanded_init_substrate"], int) or isinstance(kernel_special_demanded_init_substrate_inequality_join["summary_demanded_init_substrate"], bool) or kernel_special_demanded_init_substrate_inequality_join["summary_kernel_special_population"] <= kernel_special_demanded_init_substrate_inequality_join["summary_demanded_init_substrate"]):
        raise SystemExit("REFUSE: facade manifest kernel-special population must exceed demanded Init-substrate count " + json.dumps(kernel_special_demanded_init_substrate_inequality_join, sort_keys=True))
    ...
    structural_refused_pin_join = {
        "summary_structural_refused": manifest_summary.get("structural_refused"),
        "pinned_structural_refused": 30,
    }
    if (structural_refused_pin_join["summary_structural_refused"]
            != structural_refused_pin_join["pinned_structural_refused"]):
        raise SystemExit(
    ...
    transparent_declarations_pin_join = {
        "summary_transparent_declarations": manifest_summary.get(
            "transparent_declarations"
        ),
        "pinned_transparent_declarations": 747,
    }
    if (transparent_declarations_pin_join["summary_transparent_declarations"]
            != transparent_declarations_pin_join["pinned_transparent_declarations"]):
        raise SystemExit(
            "REFUSE: facade manifest transparent-declaration pin diverges "
            f"({json.dumps(transparent_declarations_pin_join, sort_keys=True)})"
        )
    declarations_emitted_distinct_pin_join = {
        "summary_declarations_emitted_distinct": manifest_summary.get(
            "declarations_emitted_distinct"
        ),
        "pinned_declarations_emitted_distinct": 2005,
    }
    if (declarations_emitted_distinct_pin_join["summary_declarations_emitted_distinct"]
            != declarations_emitted_distinct_pin_join["pinned_declarations_emitted_distinct"]):
        raise SystemExit(
    ...
    attempts_count_pin_join = {
        "summary_attempts_count": (
            len(manifest_summary.get("attempts"))
            if isinstance(manifest_summary.get("attempts"), list) else None
        ),
        "pinned_attempts_count": 22,
    }
    if (attempts_count_pin_join["summary_attempts_count"]
            != attempts_count_pin_join["pinned_attempts_count"]):
        raise SystemExit(
    ...
    implemented_by_probed_pin_join = {
        "summary_implemented_by_probed": manifest_summary.get(
            "implemented_by_probed"
        ),
        "pinned_implemented_by_probed": 2042,
    }
    if (implemented_by_probed_pin_join["summary_implemented_by_probed"]
            != implemented_by_probed_pin_join["pinned_implemented_by_probed"]):
        raise SystemExit(
    ...
    kind_probed_pin_join = {
        "summary_kind_probed": manifest_summary.get("kind_probed"),
        "pinned_kind_probed": 2042,
    }
    if (kind_probed_pin_join["summary_kind_probed"]
            != kind_probed_pin_join["pinned_kind_probed"]):
        raise SystemExit(
    ...
    reducibility_probed_pin_join = {
        "summary_reducibility_probed": manifest_summary.get(
            "reducibility_probed"
        ),
        "pinned_reducibility_probed": 2042,
    }
    if (reducibility_probed_pin_join["summary_reducibility_probed"]
            != reducibility_probed_pin_join["pinned_reducibility_probed"]):
        raise SystemExit(
            "REFUSE: facade manifest reducibility probe pin diverges "
            f"({json.dumps(reducibility_probed_pin_join, sort_keys=True)})"
        )
    result_head_probed_pin_join = {
        "summary_result_head_probed": manifest_summary.get("result_head_probed"),
        "pinned_result_head_probed": 2042,
    }
    if (result_head_probed_pin_join["summary_result_head_probed"]
            != result_head_probed_pin_join["pinned_result_head_probed"]):
        raise SystemExit(
    ...
    reducible_candidates_pin_join = {
        "summary_reducible_candidates": manifest_summary.get(
            "reducible_candidates"
        ),
        "pinned_reducible_candidates": 814,
    }
    if (reducible_candidates_pin_join["summary_reducible_candidates"]
            != reducible_candidates_pin_join["pinned_reducible_candidates"]):
        raise SystemExit(
    ...
    private_fields_exposed_pin_join = {
        "summary_private_fields_exposed": manifest_summary.get(
            "private_fields_exposed"
        ),
        "pinned_private_fields_exposed": 7,
    }
    if (private_fields_exposed_pin_join["summary_private_fields_exposed"]
            != private_fields_exposed_pin_join[
                "pinned_private_fields_exposed"]):
        raise SystemExit(
    ...
    structural_field_set_count_join = {
        "summary_structural_declarations": manifest_summary.get(
            "structural_declarations"
        ),
        "summary_field_sets_checked": manifest_summary.get("field_sets_checked"),
        "pinned_structural_field_set_count": 196,
    }
    if (structural_field_set_count_join["summary_structural_declarations"]
            != structural_field_set_count_join[
                "pinned_structural_field_set_count"]
            or structural_field_set_count_join["summary_field_sets_checked"]
            != structural_field_set_count_join[
                "pinned_structural_field_set_count"]):
        raise SystemExit(
            "REFUSE: facade manifest structural-field-set count diverges "
            f"({json.dumps(structural_field_set_count_join, sort_keys=True)})"
        )
    emission_distinct_count_join = {
        "summary_declarations_emitted": manifest_summary.get(
            "declarations_emitted"
        ),
        "summary_declarations_emitted_distinct": manifest_summary.get(
        ...
        "pinned_distinct_emission_count": 2005,
    }
    if (emission_distinct_count_join["summary_declarations_emitted"]
            != emission_distinct_count_join["pinned_distinct_emission_count"]
            or emission_distinct_count_join[
                "summary_declarations_emitted_distinct"]
            != emission_distinct_count_join["pinned_distinct_emission_count"]):
        raise SystemExit(
            "REFUSE: facade manifest distinct-emission count diverges "
            f"({json.dumps(emission_distinct_count_join, sort_keys=True)})"
        )
    emission_pin_presence_count_join = {
        ...
        "pinned_emission_pin_count": 2005,
    }
    if (emission_pin_presence_count_join["summary_declarations_emitted"]
            != emission_pin_presence_count_join["pinned_emission_pin_count"]
            or emission_pin_presence_count_join["summary_pin_presence_checked"]
            != emission_pin_presence_count_join["pinned_emission_pin_count"]):
        raise SystemExit(
    ...
    withdrawn_residue_zero_join = {
        "summary_emission_withdrawn": manifest_summary.get("emission_withdrawn"),
        "summary_value_residue": manifest_summary.get("value_residue"),
        "pinned_withdrawn_residue_count": 0,
    }
    if (withdrawn_residue_zero_join["summary_emission_withdrawn"]
            != withdrawn_residue_zero_join["pinned_withdrawn_residue_count"]
            or withdrawn_residue_zero_join["summary_value_residue"]
            != withdrawn_residue_zero_join["pinned_withdrawn_residue_count"]):
        raise SystemExit(
            "REFUSE: facade manifest withdrawn-residue count diverges "
            f"({json.dumps(withdrawn_residue_zero_join, sort_keys=True)})"
        )
    closure_cycle_zero_join = {
        "summary_uncensused_closure": manifest_summary.get(
            "uncensused_closure"
        ),
        "summary_cycle_residue": manifest_summary.get("cycle_residue"),
        "pinned_closure_cycle_count": 0,
    }
    if (closure_cycle_zero_join["summary_uncensused_closure"]
            != closure_cycle_zero_join["pinned_closure_cycle_count"]
            or closure_cycle_zero_join["summary_cycle_residue"]
            != closure_cycle_zero_join["pinned_closure_cycle_count"]):
        raise SystemExit(
            "REFUSE: facade manifest closure-cycle count diverges "
            f"({json.dumps(closure_cycle_zero_join, sort_keys=True)})"
        )
    emitted_cycle_zero_join = {
        "summary_uncensused_emitted": manifest_summary.get(
            "uncensused_emitted"
        ),
        "summary_cycle_residue": manifest_summary.get("cycle_residue"),
        "pinned_emitted_cycle_count": 0,
    }
    if (emitted_cycle_zero_join["summary_uncensused_emitted"]
            != emitted_cycle_zero_join["pinned_emitted_cycle_count"]
            or emitted_cycle_zero_join["summary_cycle_residue"]
            != emitted_cycle_zero_join["pinned_emitted_cycle_count"]):
        raise SystemExit(
    ...
    emitted_value_zero_join = {
        "summary_uncensused_emitted": manifest_summary.get(
            "uncensused_emitted"
        ),
        "summary_value_residue": manifest_summary.get("value_residue"),
        "pinned_emitted_value_count": 0,
    }
    if (emitted_value_zero_join["summary_uncensused_emitted"]
            != emitted_value_zero_join["pinned_emitted_value_count"]
            or emitted_value_zero_join["summary_value_residue"]
            != emitted_value_zero_join["pinned_emitted_value_count"]):
        raise SystemExit(
            "REFUSE: facade manifest emitted-value count diverges "
            f"({json.dumps(emitted_value_zero_join, sort_keys=True)})"
        )
    closure_withdrawn_zero_join = {
        "summary_uncensused_closure": manifest_summary.get(
            "uncensused_closure"
        ),
        "summary_emission_withdrawn": manifest_summary.get("emission_withdrawn"),
        "pinned_closure_withdrawn_count": 0,
    }
    if (closure_withdrawn_zero_join["summary_uncensused_closure"]
            != closure_withdrawn_zero_join["pinned_closure_withdrawn_count"]
            or closure_withdrawn_zero_join["summary_emission_withdrawn"]
            != closure_withdrawn_zero_join[
                "pinned_closure_withdrawn_count"]):
        raise SystemExit(
            "REFUSE: facade manifest closure-withdrawn count diverges "
            f"({json.dumps(closure_withdrawn_zero_join, sort_keys=True)})"
        )
    withdrawn_cycle_zero_join = {
        "summary_emission_withdrawn": manifest_summary.get("emission_withdrawn"),
        "summary_cycle_residue": manifest_summary.get("cycle_residue"),
        "pinned_withdrawn_cycle_count": 0,
    }
    if (withdrawn_cycle_zero_join["summary_emission_withdrawn"]
            != withdrawn_cycle_zero_join["pinned_withdrawn_cycle_count"]
            or withdrawn_cycle_zero_join["summary_cycle_residue"]
            != withdrawn_cycle_zero_join["pinned_withdrawn_cycle_count"]):
        raise SystemExit(
    ...
    verified_pin_presence_count_join = {
        ...
        "pinned_verified_pin_count": 2005,
    }
    if (verified_pin_presence_count_join["summary_emission_verified"]
            != verified_pin_presence_count_join["pinned_verified_pin_count"]
            or verified_pin_presence_count_join["summary_pin_presence_checked"]
            != verified_pin_presence_count_join["pinned_verified_pin_count"]):
        raise SystemExit(
    ...
    safety_implementation_probe_join = {
        ...
        "pinned_safety_implementation_count": 2042,
    }
    if (safety_implementation_probe_join["summary_safety_probed"]
            != safety_implementation_probe_join[
                "pinned_safety_implementation_count"]
            or safety_implementation_probe_join["summary_implemented_by_probed"]
            != safety_implementation_probe_join[
                "pinned_safety_implementation_count"]):
        raise SystemExit(
            "REFUSE: facade manifest safety-implementation probe diverges "
            f"({json.dumps(safety_implementation_probe_join, sort_keys=True)})"
        )
    extern_result_head_probe_join = {
        "summary_extern_probed": manifest_summary.get("extern_probed"),
        "summary_result_head_probed": manifest_summary.get("result_head_probed"),
        "pinned_extern_result_head_count": 2042,
    }
    if (extern_result_head_probe_join["summary_extern_probed"]
            != extern_result_head_probe_join["pinned_extern_result_head_count"]
            or extern_result_head_probe_join["summary_result_head_probed"]
            != extern_result_head_probe_join[
                "pinned_extern_result_head_count"]):
        raise SystemExit(
    ...
    extern_reducibility_probe_join = {
        ...
        "pinned_extern_reducibility_count": 2042,
    }
    if (extern_reducibility_probe_join["summary_extern_probed"]
            != extern_reducibility_probe_join[
                "pinned_extern_reducibility_count"]
            or extern_reducibility_probe_join["summary_reducibility_probed"]
            != extern_reducibility_probe_join[
                "pinned_extern_reducibility_count"]):
        raise SystemExit(
    ...
    module_implementation_probe_join = {
        "summary_module_probed": manifest_summary.get("module_probed"),
        "summary_implemented_by_probed": manifest_summary.get(
            "implemented_by_probed"
        ),
        "pinned_module_implementation_count": 2042,
    }
    if (module_implementation_probe_join["summary_module_probed"]
            != module_implementation_probe_join[
                "pinned_module_implementation_count"]
            or module_implementation_probe_join["summary_implemented_by_probed"]
            != module_implementation_probe_join[
                "pinned_module_implementation_count"]):
        raise SystemExit(
            "REFUSE: facade manifest module-implementation probe diverges "
            f"({json.dumps(module_implementation_probe_join, sort_keys=True)})"
        )
    safety_result_head_probe_join = {
        "summary_safety_probed": manifest_summary.get("safety_probed"),
        "summary_result_head_probed": manifest_summary.get("result_head_probed"),
        "pinned_safety_result_head_count": 2042,
    }
    if (safety_result_head_probe_join["summary_safety_probed"]
            != safety_result_head_probe_join["pinned_safety_result_head_count"]
            or safety_result_head_probe_join["summary_result_head_probed"]
            != safety_result_head_probe_join[
                "pinned_safety_result_head_count"]):
        raise SystemExit(
            "REFUSE: facade manifest safety-result-head probe diverges "
            f"({json.dumps(safety_result_head_probe_join, sort_keys=True)})"
        )
    kind_implementation_probe_join = {
        ...
        "pinned_kind_implementation_count": 2042,
    }
    if (kind_implementation_probe_join["summary_kind_probed"]
            != kind_implementation_probe_join[
                "pinned_kind_implementation_count"]
            or kind_implementation_probe_join["summary_implemented_by_probed"]
            != kind_implementation_probe_join[
                "pinned_kind_implementation_count"]):
        raise SystemExit(
    ...
    module_result_head_probe_join = {
        "summary_module_probed": manifest_summary.get("module_probed"),
        "summary_result_head_probed": manifest_summary.get("result_head_probed"),
        "pinned_module_result_head_count": 2042,
    }
    if (module_result_head_probe_join["summary_module_probed"]
            != module_result_head_probe_join[
                "pinned_module_result_head_count"]
            or module_result_head_probe_join["summary_result_head_probed"]
            != module_result_head_probe_join[
                "pinned_module_result_head_count"]):
        raise SystemExit(
            "REFUSE: facade manifest module-result-head probe diverges "
            f"({json.dumps(module_result_head_probe_join, sort_keys=True)})"
        )
    ...
    summary = {
        ...
        "manifest_roundtrip_transparent_value_inequality_join": (
            roundtrip_transparent_value_inequality_join
        ),
        ...
        "manifest_class_projection_type_inequality_join": (
            class_projection_type_inequality_join
        ),
        "manifest_substrate_bare_name_inequality_join": (
            substrate_bare_name_inequality_join
        ),
        ...
        "manifest_demanded_init_substrate_inequality_join": (
            demanded_init_substrate_inequality_join
        ),
        "manifest_demanded_init_check_inequality_join": (
            demanded_init_check_inequality_join
        ),
        "manifest_projection_transparent_declaration_inequality_join": (
            projection_transparent_declaration_inequality_join
        ),
        "manifest_projection_transparent_value_inequality_join": (
            projection_transparent_value_inequality_join
        ),
        "manifest_transparent_declaration_explicit_inequality_join": (
            transparent_declaration_explicit_inequality_join
        ),
        "manifest_roundtrip_explicit_value_inequality_join": (
            roundtrip_explicit_value_inequality_join
        ),
        ...
        "manifest_declaration_roundtrip_inequality_join": (
            declaration_roundtrip_inequality_join
        ),
        "manifest_projection_explicit_value_inequality_join": (
            projection_explicit_value_inequality_join
        ),
        ...
        "manifest_declaration_transparent_value_inequality_join": (
            declaration_transparent_value_inequality_join
        ),
        "manifest_declaration_explicit_value_inequality_join": (
            declaration_explicit_value_inequality_join
        ),
        "manifest_class_projection_bare_name_inequality_join": (
            class_projection_bare_name_inequality_join
        ),
        "manifest_class_projection_roundtrip_inequality_join": (
            class_projection_roundtrip_inequality_join
        ),
        "manifest_class_projection_transparent_inequality_join": (
            class_projection_transparent_inequality_join
        ),
        "manifest_class_projection_transparent_value_inequality_join": (
            class_projection_transparent_value_inequality_join
        ),
        ...
        "manifest_projection_emitted_demand_inequality_join": (
            projection_emitted_demand_inequality_join
        ),
        "manifest_class_projection_demand_inequality_join": (
            class_projection_demand_inequality_join
        ),
        ...
        "manifest_class_projection_kernel_special_inequality_join": (
            class_projection_kernel_special_inequality_join
        ),
        ...
        "manifest_transparent_inductive_inequality_join": (
            transparent_inductive_inequality_join
        ),
        ...
        "manifest_class_projection_emission_verification_inequality_join": (
            class_projection_emission_verification_inequality_join
        ),
        "manifest_demanded_facade_inequality_join": (
            demanded_facade_inequality_join
        ),
        ...
        "manifest_emission_structural_inequality_join": (
            emission_structural_inequality_join
        ),
        ...
        "manifest_substrate_structural_inequality_join": (
            substrate_structural_inequality_join
        ),
        "manifest_substrate_inductive_inequality_join": (
            substrate_inductive_inequality_join
        ),
        "manifest_substrate_structural_refusal_inequality_join": (
            substrate_structural_refusal_inequality_join
        ),
        "manifest_substrate_inductive_refusal_inequality_join": (
            substrate_inductive_refusal_inequality_join
        ),
        ...
        "manifest_class_projection_structural_refusal_inequality_join": (
            class_projection_structural_refusal_inequality_join
        ),
        ...
        "manifest_class_projection_private_field_inequality_join": (
            class_projection_private_field_inequality_join
        ),
        ...
        "manifest_transparent_quarantine_inequality_join": (
            transparent_quarantine_inequality_join
        ),
        "manifest_roundtrip_quarantine_inequality_join": (
            roundtrip_quarantine_inequality_join
        ),
        ...
        "manifest_emission_init_provided_inequality_join": (
            emission_init_provided_inequality_join
        ),
        "manifest_substrate_init_substrate_inequality_join": (
            substrate_init_substrate_inequality_join
        ),
        "manifest_substrate_init_provided_inequality_join": (
            substrate_init_provided_inequality_join
        ),
        ...
        "manifest_init_provided_structural_class_inequality_join": (
            init_provided_structural_class_inequality_join
        ),
        "manifest_demanded_init_substrate_private_names_inequality_join": (
            demanded_init_substrate_private_names_inequality_join
        ),
        "manifest_demanded_init_substrate_structural_refused_inequality_join": (
            demanded_init_substrate_structural_refused_inequality_join
        ),
        "manifest_demanded_init_substrate_structural_class_inequality_join": (
            demanded_init_substrate_structural_class_inequality_join
        ),
        "manifest_demanded_init_substrate_inductive_refused_inequality_join": (
            demanded_init_substrate_inductive_refused_inequality_join
        ),
        ...
        "manifest_transparent_declarations_demanded_emitted_inequality_join": (
            transparent_declarations_demanded_emitted_inequality_join
        ),
        ...
        "manifest_projection_types_init_provided_inequality_join": (
            projection_types_init_provided_inequality_join
        ),
        "manifest_type_roundtrip_demanded_emitted_inequality_join": (
            type_roundtrip_demanded_emitted_inequality_join
        ),
        "manifest_type_roundtrip_init_provided_inequality_join": (
            type_roundtrip_init_provided_inequality_join
        ),
        "manifest_type_roundtrip_demanded_init_substrate_inequality_join": (
            type_roundtrip_demanded_init_substrate_inequality_join
        ),
        ...
        "manifest_type_roundtrip_private_names_inequality_join": (
            type_roundtrip_private_names_inequality_join
        ),
        "manifest_projection_types_private_names_inequality_join": (
            projection_types_private_names_inequality_join
        ),
        ...
        "manifest_private_names_inductive_refused_inequality_join": (
            private_names_inductive_refused_inequality_join
        ),
        "manifest_demanded_field_sets_inequality_join": (
            demanded_field_sets_inequality_join
        ),
        "manifest_type_roundtrip_field_sets_inequality_join": (
            type_roundtrip_field_sets_inequality_join
        ),
        "manifest_projection_types_demanded_init_substrate_inequality_join": (
            projection_types_demanded_init_substrate_inequality_join
        ),
        "manifest_transparent_declarations_demanded_init_substrate_inequality_join": (
            transparent_declarations_demanded_init_substrate_inequality_join
        ),
        "manifest_declarations_field_sets_inequality_join": (
            declarations_field_sets_inequality_join
        ),
        "manifest_declaration_init_substrate_inequality_join": (
            declaration_init_substrate_inequality_join
        ),
        "manifest_declaration_init_provided_inequality_join": (
            declaration_init_provided_inequality_join
        ),
        ...
        "manifest_kernel_special_demanded_init_substrate_inequality_join": (
            kernel_special_demanded_init_substrate_inequality_join
        ),
        ...
        "manifest_structural_field_set_count_join": (
            structural_field_set_count_join
        ),
        "manifest_emission_distinct_count_join": emission_distinct_count_join,
        ...
        "manifest_safety_implementation_probe_join": (
            safety_implementation_probe_join
        ),
        ...
        "manifest_module_implementation_probe_join": (
            module_implementation_probe_join
        ),
        "manifest_safety_result_head_probe_join": (
            safety_result_head_probe_join
        ),
        ...
        "manifest_module_result_head_probe_join": (
            module_result_head_probe_join
        ),
