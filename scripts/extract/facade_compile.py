...
def main():
    ...
    v_facade, _, _ = run_probe(lean, root, work, "control_facade", control_names)
    v_empty, _, _ = run_probe(lean, empty_root, work, "control_empty", control_names)
    ...
    for module in sorted(modules):
        ...
        if not names:
            ...
            continue
        verdict, detail, _ = run_probe(lean, root, work, re.sub(r"\W", "_", module), names)
    ...
    summary = {
        ...
        "inputs": [input_digest(args.facade), input_digest(args.demand),
