...
// `shadow` is a reviewed authority/codec surface. It hashes only through the public
// domain registry and does not re-export or name the crate-private BLAKE3 core.
const PUBLIC_MODULES: [&str; 4] = ["canon", "domain", "root", "shadow"];
