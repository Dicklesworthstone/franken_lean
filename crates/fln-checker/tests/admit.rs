...
#[path = "admit/proof_irrelevance.rs"]
mod proof_irrelevance;

#[path = "admit/higher_order.rs"]
mod higher_order;
...
#[test]
fn kr600_803_init_and_refuses_a_forged_k() {
    let mut entries = init_and_entries();
    let declaration = entries[2].declaration();
    let metadata = declaration
        .recursor_metadata()
    ...
    assert!(
        ...
        "forged Init.And recursor k verdict: {verdict:?}"
    );
}
...
#[test]
fn kr600_803_init_and_intro_refuses_a_forged_constructor_field_count() {
    let mut entries = init_and_entries();
    let constructor = entries[1].declaration();
    entries[1] = ConstantEntry::new(
        checker_qualified(&["And", "intro"]),
    ...
    assert!(
        ...
        "forged Init.And.intro constructor field-count verdict: {verdict:?}"
    );
}

#[test]
fn kr600_803_init_and_intro_refuses_a_forged_constructor_safety() {
    let mut entries = init_and_entries();
    let constructor = entries[1].declaration();
    entries[1] = ConstantEntry::new(
        checker_qualified(&["And", "intro"]),
    ...
    assert!(
        ...
        "forged Init.And.intro constructor safety verdict: {verdict:?}"
    );
}
...
#[test]
fn kr600_803_init_and_intro_refuses_a_forged_constructor_parameter_count() {
    let mut entries = init_and_entries();
    let constructor = entries[1].declaration();
    entries[1] = ConstantEntry::new(
        checker_qualified(&["And", "intro"]),
        ConstantDeclaration::constructor(
            ...
            constructor.type_().clone(),
            constructor.safety(),
            ConstructorDeclaration::new(checker_name("And"), 0, 3, 2),
        ),
    );
    let verdict = admit_inductive(
        &ConstantEnvironment::empty(),
    ...
    assert!(
        ...
        "forged Init.And.intro constructor parameter-count verdict: {verdict:?}"
    );
}
...
#[test]
fn kr600_803_init_bool_false_refuses_a_forged_constructor_field_count() {
    let mut entries = init_bool_entries();
    let constructor = entries[1].declaration();
    entries[1] = ConstantEntry::new(
        checker_qualified(&["Bool", "false"]),
    ...
    assert!(
        ...
        "forged Init.Bool.false constructor field-count verdict: {verdict:?}"
    );
}

#[test]
fn kr600_803_init_bool_false_refuses_a_forged_out_of_range_constructor_field_count() {
    let mut entries = init_bool_entries();
    let constructor = entries[1].declaration();
    entries[1] = ConstantEntry::new(
        checker_qualified(&["Bool", "false"]),
        ConstantDeclaration::constructor(
            ...
            constructor.type_().clone(),
            constructor.safety(),
            ConstructorDeclaration::new(checker_name("Bool"), 0, 0, 2),
        ),
    );
    let verdict = admit_inductive(
        &ConstantEnvironment::empty(),
    ...
    assert!(
        ...
        "forged Bool.false constructor out-of-range field-count verdict: {verdict:?}"
    );
}
...
fn kr600_803_init_bool_false_refuses_a_forged_constructor_index() {
    ...
    assert!(
        ...
        "forged Init.Bool.false constructor-index verdict: {verdict:?}"
    );
}
...
fn kr600_803_init_bool_false_refuses_a_forged_constructor_safety() {
    ...
    entries[1] = ConstantEntry::new(
        ...
        ConstantDeclaration::constructor(
            ...
            constructor.type_().clone(),
            ConstantSafety::Unsafe,
            ConstructorDeclaration::new(checker_name("Bool"), 0, 0, 0),
        ),
    );
    let verdict = admit_inductive(
        &ConstantEnvironment::empty(),
    ...
    assert!(
        ...
        "forged Init.Bool.false constructor safety verdict: {verdict:?}"
    );
}

#[test]
fn kr600_803_init_bool_false_refuses_a_forged_constructor_inductive_owner() {
    let mut entries = init_bool_entries();
    let constructor = entries[1].declaration();
    entries[1] = ConstantEntry::new(
        checker_qualified(&["Bool", "false"]),
        ConstantDeclaration::constructor(
            ...
            constructor.type_().clone(),
            constructor.safety(),
            ConstructorDeclaration::new(checker_name("NotBool"), 0, 0, 0),
        ),
    );
    let verdict = admit_inductive(
        &ConstantEnvironment::empty(),
    ...
    assert!(
        ...
        "forged Init.Bool.false constructor inductive-owner verdict: {verdict:?}"
    );
}

#[test]
fn kr600_803_init_bool_false_refuses_a_forged_constructor_parameter_count() {
    let mut entries = init_bool_entries();
    let constructor = entries[1].declaration();
    entries[1] = ConstantEntry::new(
        checker_qualified(&["Bool", "false"]),
        ConstantDeclaration::constructor(
            ...
            constructor.type_().clone(),
            constructor.safety(),
            ConstructorDeclaration::new(checker_name("Bool"), 0, 1, 0),
        ),
    );
    let verdict = admit_inductive(
        &ConstantEnvironment::empty(),
    ...
    assert!(
        ...
        "forged Init.Bool.false constructor parameter-count verdict: {verdict:?}"
    );
}

#[test]
fn kr600_803_init_bool_false_refuses_a_forged_constructor_level_parameter_count() {
    let mut entries = init_bool_entries();
    let constructor = entries[1].declaration();
    let mut levels = constructor.level_parameters().to_vec();
    levels.push(checker_name("u"));
    ...
    assert!(
        ...
        "forged Init.Bool.false constructor level-parameter count verdict: {verdict:?}"
    );
}

#[test]
fn kr600_803_init_bool_true_refuses_a_forged_constructor_index() {
    let mut entries = init_bool_entries();
    let constructor = entries[2].declaration();
    entries[2] = ConstantEntry::new(
        checker_qualified(&["Bool", "true"]),
    ...
    assert!(
        ...
        "forged Init.Bool.true constructor-index verdict: {verdict:?}"
    );
}

#[test]
fn kr600_803_init_bool_true_refuses_a_forged_out_of_range_constructor_index() {
    let mut entries = init_bool_entries();
    let constructor = entries[2].declaration();
    entries[2] = ConstantEntry::new(
        checker_qualified(&["Bool", "true"]),
    ...
    assert!(
        ...
        "forged Bool.true constructor out-of-range index verdict: {verdict:?}"
    );
}

#[test]
fn kr600_803_init_bool_true_refuses_a_forged_constructor_safety() {
    let mut entries = init_bool_entries();
    let constructor = entries[2].declaration();
    entries[2] = ConstantEntry::new(
        checker_qualified(&["Bool", "true"]),
    ...
    assert!(
        ...
        "forged Init.Bool.true constructor safety verdict: {verdict:?}"
    );
}

#[test]
fn kr600_803_init_bool_true_refuses_a_forged_constructor_inductive_owner() {
    let mut entries = init_bool_entries();
    let constructor = entries[2].declaration();
    entries[2] = ConstantEntry::new(
        checker_qualified(&["Bool", "true"]),
        ConstantDeclaration::constructor(
            ...
            constructor.type_().clone(),
            constructor.safety(),
            ConstructorDeclaration::new(checker_name("NotBool"), 1, 0, 0),
        ),
    );
    let verdict = admit_inductive(
        &ConstantEnvironment::empty(),
    ...
    assert!(
        ...
        "forged Init.Bool.true constructor inductive-owner verdict: {verdict:?}"
    );
}
...
#[test]
fn kr600_803_init_bool_true_refuses_a_forged_constructor_level_parameter_count() {
    let mut entries = init_bool_entries();
    let constructor = entries[2].declaration();
    let mut levels = constructor.level_parameters().to_vec();
    levels.push(checker_name("u"));
    ...
    assert!(
        ...
        "forged Init.Bool.true constructor level-parameter count verdict: {verdict:?}"
    );
}
...
#[test]
fn kr600_803_init_bool_refuses_a_forged_k() {
    let mut entries = init_bool_entries();
    let declaration = entries[3].declaration();
    let metadata = declaration
        .recursor_metadata()
    ...
    assert!(
        ...
        "forged Init.Bool recursor k verdict: {verdict:?}"
    );
}
...
#[test]
fn kr600_803_init_punit_refuses_a_forged_out_of_range_constructor_index() {
    let mut entries = init_punit_entries();
    let constructor = entries[1].declaration();
    entries[1] = ConstantEntry::new(
        checker_qualified(&["PUnit", "unit"]),
        ConstantDeclaration::constructor(
            ...
            constructor.type_().clone(),
            constructor.safety(),
            ConstructorDeclaration::new(checker_name("PUnit"), 2, 0, 0),
        ),
    );
    let verdict = admit_inductive(
        &ConstantEnvironment::empty(),
    ...
    assert!(
        ...
        "forged PUnit constructor out-of-range index verdict: {verdict:?}"
    );
}
...
#[test]
fn kr600_803_init_punit_refuses_a_forged_k() {
    let mut entries = init_punit_entries();
    let declaration = entries[2].declaration();
    let metadata = declaration
        .recursor_metadata()
    ...
    assert!(
        ...
        "forged Init.PUnit recursor k verdict: {verdict:?}"
    );
}
...
#[test]
fn kr600_803_init_unit_refuses_a_forged_out_of_range_constructor_index() {
    let mut entries = init_unit_entries();
    let constructor = entries[1].declaration();
    entries[1] = ConstantEntry::new(
        checker_qualified(&["Unit", "unit"]),
        ConstantDeclaration::constructor(
            ...
            constructor.type_().clone(),
            constructor.safety(),
            ConstructorDeclaration::new(checker_name("Unit"), 2, 0, 0),
        ),
    );
    let verdict = admit_inductive(
        &ConstantEnvironment::empty(),
    ...
    assert!(
        ...
        "forged Unit constructor out-of-range index verdict: {verdict:?}"
    );
}
...
#[test]
fn kr600_803_init_unit_refuses_a_forged_k() {
    let mut entries = init_unit_entries();
    let declaration = entries[2].declaration();
    let metadata = declaration
        .recursor_metadata()
    ...
    assert!(
        ...
        "forged Init.Unit recursor k verdict: {verdict:?}"
    );
}
...
#[test]
fn kr600_803_init_sum_refuses_a_forged_k() {
    ...
    assert!(
        ...
        "forged Init.Sum recursor k verdict: {verdict:?}"
    );
}
...
#[test]
fn kr600_803_init_sum_inl_refuses_a_forged_constructor_field_count() {
    let mut entries = init_sum_entries();
    let constructor = entries[1].declaration();
    entries[1] = ConstantEntry::new(
        checker_qualified(&["Sum", "inl"]),
        ConstantDeclaration::constructor(
            ...
            constructor.type_().clone(),
            constructor.safety(),
            ConstructorDeclaration::new(checker_name("Sum"), 0, 2, 2),
        ),
    );
    assert!(matches!(
        admit_inductive(
...
#[test]
fn kr600_803_color_blue_refuses_a_forged_constructor_field_count() {
    let mut entries = enumeration_entries(BinderInfo::Implicit);
    let constructor = entries[2].declaration();
    entries[2] = ConstantEntry::new(
        checker_qualified(&["Color", "blue"]),
        ConstantDeclaration::constructor(
            ...
            constructor.type_().clone(),
            constructor.safety(),
            ConstructorDeclaration::new(checker_name("Color"), 1, 0, 1),
        ),
    );
    let verdict = admit_inductive(
        &ConstantEnvironment::empty(),
    ...
    assert!(
        ...
        "forged Color.blue constructor field-count verdict: {verdict:?}"
    );
}

#[test]
fn kr600_803_color_blue_refuses_a_forged_constructor_index() {
    let mut entries = enumeration_entries(BinderInfo::Implicit);
    let constructor = entries[2].declaration();
    entries[2] = ConstantEntry::new(
        checker_qualified(&["Color", "blue"]),
    ...
    assert!(
        ...
        "forged Color.blue constructor-index verdict: {verdict:?}"
    );
}

#[test]
fn kr600_803_color_blue_refuses_a_forged_constructor_parameter_count() {
    let mut entries = enumeration_entries(BinderInfo::Implicit);
    let constructor = entries[2].declaration();
    entries[2] = ConstantEntry::new(
        checker_qualified(&["Color", "blue"]),
        ConstantDeclaration::constructor(
            ...
            constructor.type_().clone(),
            constructor.safety(),
            ConstructorDeclaration::new(checker_name("Color"), 1, 1, 0),
        ),
    );
    let verdict = admit_inductive(
        &ConstantEnvironment::empty(),
    ...
    assert!(
        ...
        "forged Color.blue constructor parameter-count verdict: {verdict:?}"
    );
}
...
#[test]
fn kr600_803_color_blue_refuses_a_forged_constructor_level_parameter_count() {
    let mut entries = enumeration_entries(BinderInfo::Implicit);
    let constructor = entries[2].declaration();
    let mut levels = constructor.level_parameters().to_vec();
    levels.push(checker_name("u"));
    ...
    assert!(
        ...
        "forged Color.blue constructor level-parameter count verdict: {verdict:?}"
    );
}

#[test]
fn kr600_803_color_red_refuses_a_forged_constructor_level_parameter_count() {
    let mut entries = enumeration_entries(BinderInfo::Implicit);
    let constructor = entries[1].declaration();
    let mut levels = constructor.level_parameters().to_vec();
    levels.push(checker_name("u"));
    ...
    assert!(
        ...
        "forged Color.red constructor level-parameter count verdict: {verdict:?}"
    );
}

#[test]
fn kr600_803_color_blue_refuses_a_forged_constructor_inductive_owner() {
    let mut entries = enumeration_entries(BinderInfo::Implicit);
    let constructor = entries[2].declaration();
    entries[2] = ConstantEntry::new(
        checker_qualified(&["Color", "blue"]),
        ConstantDeclaration::constructor(
            ...
            constructor.type_().clone(),
            constructor.safety(),
            ConstructorDeclaration::new(checker_name("NotColor"), 1, 0, 0),
        ),
    );
    let verdict = admit_inductive(
        &ConstantEnvironment::empty(),
    ...
    assert!(
        ...
        "forged Color.blue constructor inductive-owner verdict: {verdict:?}"
    );
}

#[test]
fn kr600_803_color_red_refuses_a_forged_constructor_inductive_owner() {
    let mut entries = enumeration_entries(BinderInfo::Implicit);
    let constructor = entries[1].declaration();
    entries[1] = ConstantEntry::new(
        checker_qualified(&["Color", "red"]),
        ConstantDeclaration::constructor(
            ...
            constructor.type_().clone(),
            constructor.safety(),
            ConstructorDeclaration::new(checker_name("NotColor"), 0, 0, 0),
        ),
    );
    let verdict = admit_inductive(
        &ConstantEnvironment::empty(),
    ...
    assert!(
        ...
        "forged Color.red constructor inductive-owner verdict: {verdict:?}"
    );
}
...
#[test]
fn kr600_803_color_red_refuses_a_forged_constructor_safety() {
    let mut entries = enumeration_entries(BinderInfo::Implicit);
    let constructor = entries[1].declaration();
    entries[1] = ConstantEntry::new(
        checker_qualified(&["Color", "red"]),
    ...
    assert!(
        ...
        "forged Color.red constructor safety verdict: {verdict:?}"
    );
}
...
fn kr600_803_witness_mk_refuses_a_forged_constructor_field_count() {
    ...
    entries[1] = ConstantEntry::new(
        ...
        ConstantDeclaration::constructor(
            ...
            constructor.type_().clone(),
            constructor.safety(),
            ConstructorDeclaration::new(checker_name("Witness"), 0, 0, 3),
        ),
    );
    let verdict = admit_inductive(
        &ConstantEnvironment::empty(),
    ...
    assert!(
        ...
        "forged Witness.mk constructor field-count verdict: {verdict:?}"
    );
}

#[test]
fn kr600_803_witness_mk_refuses_a_forged_constructor_parameter_count() {
    let mut entries = dependent_field_inductive_entries();
    let constructor = entries[1].declaration();
    entries[1] = ConstantEntry::new(
        checker_qualified(&["Witness", "mk"]),
        ConstantDeclaration::constructor(
            ...
            constructor.type_().clone(),
            constructor.safety(),
            ConstructorDeclaration::new(checker_name("Witness"), 0, 1, 2),
        ),
    );
    let verdict = admit_inductive(
        &ConstantEnvironment::empty(),
    ...
    assert!(
        ...
        "forged Witness.mk constructor parameter-count verdict: {verdict:?}"
    );
}
...
#[test]
fn kr600_803_witness_mk_refuses_a_forged_constructor_safety() {
    let mut entries = dependent_field_inductive_entries();
    let constructor = entries[1].declaration();
    entries[1] = ConstantEntry::new(
        checker_qualified(&["Witness", "mk"]),
    ...
    assert!(
        ...
        "forged Witness.mk constructor safety verdict: {verdict:?}"
    );
}
...
#[test]
fn kr600_803_init_nat_zero_refuses_a_forged_constructor_safety() {
    let mut entries = nat_entries();
    let constructor = entries[1].declaration();
    entries[1] = ConstantEntry::new(
        checker_qualified(&["Nat", "zero"]),
        ConstantDeclaration::constructor(
            ...
            constructor.type_().clone(),
            ConstantSafety::Unsafe,
            ConstructorDeclaration::new(checker_name("Nat"), 0, 0, 0),
        ),
    );
    let verdict = admit_inductive(
        &ConstantEnvironment::empty(),
    ...
    assert!(
        ...
        "forged Nat.zero constructor safety verdict: {verdict:?}"
    );
}
...
fn kr600_803_init_nat_succ_refuses_a_forged_constructor_field_count() {
    ...
    assert!(
        ...
        "forged Nat.succ constructor field-count verdict: {verdict:?}"
    );
}
...
#[test]
fn kr600_803_init_nat_succ_refuses_a_forged_constructor_safety() {
    let mut entries = nat_entries();
    let constructor = entries[2].declaration();
    entries[2] = ConstantEntry::new(
        checker_qualified(&["Nat", "succ"]),
    ...
    assert!(
        ...
        "forged Nat.succ constructor safety verdict: {verdict:?}"
    );
}

#[test]
fn kr600_803_init_nat_succ_refuses_a_forged_constructor_inductive_owner() {
    let mut entries = nat_entries();
    let constructor = entries[2].declaration();
    entries[2] = ConstantEntry::new(
        checker_qualified(&["Nat", "succ"]),
        ConstantDeclaration::constructor(
            ...
            constructor.type_().clone(),
            constructor.safety(),
            ConstructorDeclaration::new(checker_name("NotNat"), 1, 0, 1),
        ),
    );
    let verdict = admit_inductive(
        &ConstantEnvironment::empty(),
    ...
    assert!(
        ...
        "forged Nat.succ constructor inductive-owner verdict: {verdict:?}"
    );
}
...
#[test]
fn kr600_803_init_nat_refuses_a_forged_k() {
    let mut entries = nat_entries();
    let declaration = entries[3].declaration();
    let metadata = declaration
        .recursor_metadata()
    ...
    assert!(
        ...
        "forged Init.Nat recursor k verdict: {verdict:?}"
    );
}
...
#[test]
fn kr600_803_init_option_some_refuses_a_forged_constructor_index() {
    let mut entries = init_option_entries();
    let constructor = entries[2].declaration();
    entries[2] = ConstantEntry::new(
        checker_qualified(&["Option", "some"]),
...
#[test]
fn kr600_803_init_option_none_refuses_a_forged_constructor_index() {
    let mut entries = init_option_entries();
    let constructor = entries[1].declaration();
    entries[1] = ConstantEntry::new(
        ...
        ConstantDeclaration::constructor(
            ...
            constructor.type_().clone(),
            constructor.safety(),
            ConstructorDeclaration::new(checker_name("Option"), 1, 1, 0),
        ),
    );
    let verdict = admit_inductive(
        &ConstantEnvironment::empty(),
    ...
    assert!(
        ...
        "forged Option.none constructor-index verdict: {verdict:?}"
    );
}

#[test]
fn kr600_803_init_option_none_refuses_a_forged_constructor_field_count() {
    let mut entries = init_option_entries();
    let constructor = entries[1].declaration();
    entries[1] = ConstantEntry::new(
        checker_qualified(&["Option", "none"]),
    ...
    assert!(
        ...
        "forged Option.none constructor field-count verdict: {verdict:?}"
    );
}

#[test]
fn kr600_803_init_option_none_refuses_a_forged_constructor_safety() {
    let mut entries = init_option_entries();
    let constructor = entries[1].declaration();
    entries[1] = ConstantEntry::new(
        checker_qualified(&["Option", "none"]),
        ConstantDeclaration::constructor(
            ...
            constructor.type_().clone(),
            ConstantSafety::Unsafe,
            ConstructorDeclaration::new(checker_name("Option"), 0, 1, 0),
        ),
    );
    let verdict = admit_inductive(
        &ConstantEnvironment::empty(),
    ...
    assert!(
        ...
        "forged Init.Option.none constructor safety verdict: {verdict:?}"
    );
}

#[test]
fn kr600_803_init_option_none_refuses_a_forged_constructor_inductive_owner() {
    let mut entries = init_option_entries();
    let constructor = entries[1].declaration();
    entries[1] = ConstantEntry::new(
        checker_qualified(&["Option", "none"]),
        ConstantDeclaration::constructor(
            ...
            constructor.type_().clone(),
            constructor.safety(),
            ConstructorDeclaration::new(checker_name("NotOption"), 0, 1, 0),
        ),
    );
    let verdict = admit_inductive(
        &ConstantEnvironment::empty(),
    ...
    assert!(
        ...
        "forged Init.Option.none constructor inductive-owner verdict: {verdict:?}"
    );
}

#[test]
fn kr600_803_init_option_none_refuses_a_forged_constructor_parameter_count() {
    let mut entries = init_option_entries();
    let constructor = entries[1].declaration();
    entries[1] = ConstantEntry::new(
        checker_qualified(&["Option", "none"]),
        ConstantDeclaration::constructor(
            ...
            constructor.type_().clone(),
            constructor.safety(),
            ConstructorDeclaration::new(checker_name("Option"), 0, 2, 0),
        ),
    );
    let verdict = admit_inductive(
        &ConstantEnvironment::empty(),
    ...
    assert!(
        ...
        "forged Init.Option.none constructor parameter-count verdict: {verdict:?}"
    );
}

#[test]
fn kr600_803_init_option_none_refuses_a_forged_constructor_level_parameter_count() {
    let mut entries = init_option_entries();
    let constructor = entries[1].declaration();
    let mut levels = constructor.level_parameters().to_vec();
    ...
    assert!(
        ...
        "forged Init.Option.none constructor level-parameter count verdict: {verdict:?}"
    );
}

#[test]
fn kr600_803_init_option_some_refuses_a_forged_constructor_safety() {
    let mut entries = init_option_entries();
    let constructor = entries[2].declaration();
    entries[2] = ConstantEntry::new(
        checker_qualified(&["Option", "some"]),
        ConstantDeclaration::constructor(
            ...
            constructor.type_().clone(),
            ConstantSafety::Unsafe,
            ConstructorDeclaration::new(checker_name("Option"), 1, 1, 1),
        ),
    );
    let verdict = admit_inductive(
        &ConstantEnvironment::empty(),
    ...
    assert!(
        ...
        "forged Option.some constructor safety verdict: {verdict:?}"
    );
}
...
#[test]
fn kr600_803_init_option_some_refuses_a_forged_constructor_parameter_count() {
    let mut entries = init_option_entries();
    let constructor = entries[2].declaration();
    entries[2] = ConstantEntry::new(
        checker_qualified(&["Option", "some"]),
        ConstantDeclaration::constructor(
            ...
            constructor.type_().clone(),
            constructor.safety(),
            ConstructorDeclaration::new(checker_name("Option"), 1, 2, 1),
        ),
    );
    let verdict = admit_inductive(
        &ConstantEnvironment::empty(),
    ...
    assert!(
        ...
        "forged Option.some constructor parameter-count verdict: {verdict:?}"
    );
}

#[test]
fn kr600_803_init_option_some_refuses_a_forged_constructor_level_parameter_count() {
    let mut entries = init_option_entries();
    let constructor = entries[2].declaration();
    let mut levels = constructor.level_parameters().to_vec();
    levels.push(checker_name("v"));
    ...
    assert!(
        ...
        "forged Option.some constructor level-parameter count verdict: {verdict:?}"
    );
}
...
#[test]
fn kr600_803_init_list_cons_refuses_a_forged_constructor_safety() {
    let mut entries = init_list_entries();
    let constructor = entries[2].declaration();
    entries[2] = ConstantEntry::new(
        checker_qualified(&["List", "cons"]),
        ConstantDeclaration::constructor(
            ...
            constructor.type_().clone(),
            ConstantSafety::Unsafe,
            ConstructorDeclaration::new(checker_name("List"), 1, 1, 2),
        ),
    );
    let verdict = admit_inductive(
        &ConstantEnvironment::empty(),
    ...
    assert!(
        ...
        "forged List.cons constructor safety verdict: {verdict:?}"
    );
}

#[test]
fn kr600_803_init_list_cons_refuses_a_forged_constructor_inductive_owner() {
    let mut entries = init_list_entries();
    let constructor = entries[2].declaration();
    entries[2] = ConstantEntry::new(
        checker_qualified(&["List", "cons"]),
        ConstantDeclaration::constructor(
            ...
            constructor.type_().clone(),
            constructor.safety(),
            ConstructorDeclaration::new(checker_name("NotList"), 1, 1, 2),
        ),
    );
    let verdict = admit_inductive(
        &ConstantEnvironment::empty(),
    ...
    assert!(
        ...
        "forged List.cons constructor inductive-owner verdict: {verdict:?}"
    );
}

#[test]
fn kr600_803_init_list_cons_refuses_a_forged_constructor_parameter_count() {
    let mut entries = init_list_entries();
    let constructor = entries[2].declaration();
    entries[2] = ConstantEntry::new(
        checker_qualified(&["List", "cons"]),
        ConstantDeclaration::constructor(
            ...
            constructor.type_().clone(),
            constructor.safety(),
            ConstructorDeclaration::new(checker_name("List"), 1, 2, 2),
        ),
    );
    let verdict = admit_inductive(
        &ConstantEnvironment::empty(),
    ...
    assert!(
        ...
        "forged List.cons constructor parameter-count verdict: {verdict:?}"
    );
}

#[test]
fn kr600_803_init_list_cons_refuses_a_forged_constructor_level_parameter_count() {
    let mut entries = init_list_entries();
    let constructor = entries[2].declaration();
    let mut levels = constructor.level_parameters().to_vec();
    levels.push(checker_name("v"));
    ...
    assert!(
        ...
        "forged List.cons constructor level-parameter count verdict: {verdict:?}"
    );
}

#[test]
fn kr600_803_init_list_nil_refuses_a_forged_constructor_index() {
    let mut entries = init_list_entries();
    let constructor = entries[1].declaration();
    entries[1] = ConstantEntry::new(
        ...
        ConstantDeclaration::constructor(
            ...
            constructor.type_().clone(),
            constructor.safety(),
            ConstructorDeclaration::new(checker_name("List"), 1, 1, 0),
        ),
    );
    assert!(matches!(
        admit_inductive(
...
#[test]
fn kr600_803_init_list_nil_refuses_a_forged_constructor_safety() {
    let mut entries = init_list_entries();
    let constructor = entries[1].declaration();
    entries[1] = ConstantEntry::new(
        checker_qualified(&["List", "nil"]),
    ...
    assert!(
        ...
        "forged List.nil constructor safety verdict: {verdict:?}"
    );
}
...
#[test]
fn kr600_803_init_list_nil_refuses_a_forged_constructor_parameter_count() {
    let mut entries = init_list_entries();
    let constructor = entries[1].declaration();
    entries[1] = ConstantEntry::new(
        checker_qualified(&["List", "nil"]),
        ConstantDeclaration::constructor(
            ...
            constructor.type_().clone(),
            constructor.safety(),
            ConstructorDeclaration::new(checker_name("List"), 0, 2, 0),
        ),
    );
    let verdict = admit_inductive(
        &ConstantEnvironment::empty(),
    ...
    assert!(
        ...
        "forged List.nil constructor parameter-count verdict: {verdict:?}"
    );
}
...
fn kr600_803_init_list_cons_refuses_a_forged_constructor_field_count() {
    ...
    entries[2] = ConstantEntry::new(
        ...
        ConstantDeclaration::constructor(
            ...
            constructor.type_().clone(),
            constructor.safety(),
            ConstructorDeclaration::new(checker_name("List"), 1, 1, 3),
        ),
    );
    assert!(matches!(
        admit_inductive(
...
#[test]
fn kr600_803_init_list_nil_refuses_a_forged_constructor_field_count() {
    let mut entries = init_list_entries();
    let constructor = entries[1].declaration();
    entries[1] = ConstantEntry::new(
        checker_qualified(&["List", "nil"]),
        ConstantDeclaration::constructor(
            ...
            constructor.type_().clone(),
            constructor.safety(),
            ConstructorDeclaration::new(checker_name("List"), 0, 1, 1),
        ),
    );
    assert!(matches!(
        admit_inductive(
...
#[test]
fn kr600_803_init_list_refuses_a_forged_k() {
    let mut entries = init_list_entries();
    let declaration = entries[3].declaration();
    let metadata = declaration
        .recursor_metadata()
    ...
    assert!(
        ...
        "forged Init.List recursor k verdict: {verdict:?}"
    );
}
...
fn kr600_803_init_empty_refuses_a_forged_k() {
    ...
    assert!(
        ...
        "forged Init.Empty recursor k verdict: {verdict:?}"
    );
}
...
#[test]
fn kr600_803_init_false_refuses_a_forged_k() {
    let mut entries = init_false_entries();
    let declaration = entries[1].declaration();
    let metadata = declaration
        .recursor_metadata()
    ...
    assert!(
        ...
        "forged Init.False recursor k verdict: {verdict:?}"
    );
}
...
#[test]
fn kr600_803_init_pempty_refuses_a_forged_k() {
    let mut entries = init_pempty_entries();
    let declaration = entries[1].declaration();
    let metadata = declaration
        .recursor_metadata()
    ...
    assert!(
        ...
        "forged Init.PEmpty recursor k verdict: {verdict:?}"
    );
}
...
#[test]
fn kr600_803_init_or_refuses_a_forged_k() {
    let mut entries = init_or_entries();
    let declaration = entries[3].declaration();
    let metadata = declaration
        .recursor_metadata()
    ...
    assert!(
        ...
        "forged Init.Or recursor k verdict: {verdict:?}"
    );
}
...
#[test]
fn kr600_803_init_or_inr_refuses_a_forged_constructor_field_count() {
    let mut entries = init_or_entries();
    let constructor = entries[2].declaration();
    entries[2] = ConstantEntry::new(
        checker_qualified(&["Or", "inr"]),
        ConstantDeclaration::constructor(
            ...
            constructor.type_().clone(),
            constructor.safety(),
            ConstructorDeclaration::new(checker_name("Or"), 1, 2, 2),
        ),
    );
    let verdict = admit_inductive(
        &ConstantEnvironment::empty(),
    ...
    assert!(
        ...
        "forged Init.Or.inr field-count verdict: {verdict:?}"
    );
}
