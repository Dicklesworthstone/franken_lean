...
//!   equality with `lt.is_equiv(ls)`, and `tc.rs:3017`/`3485`/`4725` decide
...
//!   `!has_fvar()` (`tc.rs:4345`/`4540`). An under-reporting flag makes
...
//! cite crates/fln-kernel/src/tc.rs:4725 :: ExprNode::Sort { level } @@ fn infer_proj
//! cite crates/fln-kernel/src/tc.rs:1528 :: e.loose_bvar_range() <= k
//! cite crates/fln-kernel/src/tc.rs:4345 :: !e.has_fvar() || active == 0
//! cite crates/fln-kernel/src/tc.rs:4540 :: if !e.has_fvar() {
