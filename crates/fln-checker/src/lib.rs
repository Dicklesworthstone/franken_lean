...
//!   equality with `lt.is_equiv(ls)`, and `tc.rs:3017`/`3485`/`4737` decide
...
//!   `!has_fvar()` (`tc.rs:4357`/`4552`). An under-reporting flag makes
...
//! cite crates/fln-kernel/src/tc.rs:4737 :: ExprNode::Sort { level } @@ fn infer_proj
//! cite crates/fln-kernel/src/tc.rs:1528 :: e.loose_bvar_range() <= k
//! cite crates/fln-kernel/src/tc.rs:4357 :: !e.has_fvar() || active == 0
//! cite crates/fln-kernel/src/tc.rs:4552 :: if !e.has_fvar() {
