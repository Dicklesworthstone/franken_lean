...
// (The regenerated table below carries measured NUMERIC errnos, so the old
// named-constant import is gone with the named population it mirrored.)
...
// population widened to a 1..=200 numeric sweep by franken_lean-83r's
// decode-export differential, which caught the original named-errno scope
// under-derived by NINE libuv-mapped codes). The table carries exactly the
// contract rows whose details differ from the "Unknown system error N"
// shape; the fallback arm below IS that shape, and the contract's
// Unknown-class rows (134 of 200) pin it byte-for-byte.
...
const UV_ERROR_ROWS: &[(c_int, u8, &str)] = &[
    (1, 13, "operation not permitted"),
    (2, 11, "no such file or directory"),
    (3, 16, "no such process"),
    (4, 10, "interrupted system call"),
    (5, 5, "i/o error"),
    (6, 16, "no such device or address"),
    (7, 14, "argument list too long"),
    (9, 12, "bad file descriptor"),
    (11, 14, "resource temporarily unavailable"),
    (12, 14, "not enough memory"),
    (13, 13, "permission denied"),
    (14, 1, "bad address in system call argument"),
    (16, 2, "resource busy or locked"),
    (17, 0, "file already exists"),
    (18, 4, "cross-device link not permitted"),
    (19, 4, "no such device"),
    (20, 15, "not a directory"),
    (21, 15, "illegal operation on a directory"),
    (22, 12, "invalid argument"),
    (23, 14, "file table overflow"),
    (24, 14, "too many open files"),
    (25, 7, "inappropriate ioctl for device"),
    (26, 2, "text file is busy"),
    (27, 13, "file too large"),
    (28, 14, "no space left on device"),
    (29, 4, "invalid seek"),
    (30, 13, "read-only file system"),
    (31, 14, "too many links"),
    (32, 3, "broken pipe"),
    (34, 4, "result too large"),
    (36, 12, "name too long"),
    (38, 4, "function not implemented"),
    (39, 6, "directory not empty"),
    (40, 12, "too many symbolic links encountered"),
    (49, 1, "protocol driver not attached"),
    (61, 16, "no data available"),
    (64, 1, "machine is not on the network"),
    (71, 8, "protocol error"),
    (75, 1, "value too large for defined data type"),
    (84, 12, "illegal byte sequence"),
    (88, 12, "socket operation on non-socket"),
    (89, 12, "destination address required"),
    (90, 14, "message too long"),
    (91, 8, "protocol wrong type for socket"),
    (92, 4, "protocol not available"),
    (93, 8, "protocol not supported"),
    (94, 1, "socket type not supported"),
    (95, 4, "operation not supported on socket"),
    (97, 4, "address family not supported"),
    (98, 2, "address already in use"),
    (99, 4, "address not available"),
    (100, 3, "network is down"),
    (101, 16, "network is unreachable"),
    (103, 13, "software caused connection abort"),
    (104, 3, "connection reset by peer"),
    (105, 14, "no buffer space available"),
    (106, 0, "socket is already connected"),
    (107, 12, "socket is not connected"),
    (108, 1, "cannot send after transport endpoint shutdown"),
    (110, 9, "connection timed out"),
    (111, 16, "connection refused"),
    (112, 1, "host is down"),
    (113, 16, "host is unreachable"),
    (114, 1, "connection already in progress"),
    (121, 1, "remote I/O error"),
    (125, 1, "operation canceled"),
];
