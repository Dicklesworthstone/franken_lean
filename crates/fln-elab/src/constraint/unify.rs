...
/// Normalize universe maxima, successor offsets and guarded imax identities.
/// This is a metered sufficient conversion test, not a choice of hole values.
fn simplify_level(level: &Level, meter: &mut Meter<'_>) -> Result<Level, UnificationError> {
    normalize::simplify(level, meter)
}
