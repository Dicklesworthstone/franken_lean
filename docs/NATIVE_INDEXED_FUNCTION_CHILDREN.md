...
fields are supported separately (`NATIVE_MUTUAL_INDEXED_RUNTIME.md`), as are
function-valued mutual children (`NATIVE_MUTUAL_FUNCTION_CHILDREN.md`). Type-indexed GADTs, dependent callback argument
